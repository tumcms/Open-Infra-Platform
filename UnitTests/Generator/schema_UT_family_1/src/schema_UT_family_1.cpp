...
class Schema_UT_family_1_Test : public Test {
    protected:
    ...
    const std::string filepathGenerated = "UnitTests/Generator/schema_UT_family_1/Generated/src";

};

TEST_F(Schema_UT_family_1_Test, AllFilesAreGenerated) {
