...
class Schema_UT_family_2_Test : public Test {
    protected:
    ...
    const std::string filepathGenerated = "UnitTests/Generator/schema_UT_family_2/Generated/src";

};

TEST_F(Schema_UT_family_2_Test, AllFilesAreGenerated) {
	...
	EXPECT_THAT(getNumberOfFilesInFolder(filepathGenerated + "/entity", false), Eq(6));
