...
class VienneseBend : public IfcVisualTest {
protected:
	...
	virtual std::string TestName() const { return "viennese-bend_100.0_300_1000_1_Meter"; }
	virtual std::string Schema() const { return "IFC4X3_RC4"; }

	const boost::filesystem::path filename = dataPath("viennese-bend_100.0_300_1000_1_Meter.ifc");
...
TEST_F(VienneseBend, ImageIsSaved)
{
	...
	// Act
	buw::storeImage(testPath("viennese-bend_100.0_300_1000_1_Meter.png").string(), image);

	// Assert
	EXPECT_NO_THROW(buw::loadImage4b(testPath("viennese-bend_100.0_300_1000_1_Meter.png").string()));
}
