...
protected:
	...
	virtual std::string TestName() const { return "line_100.0_1000_300_1_Meter"; }
	virtual std::string Schema() const { return "IFC4X3_RC4"; }

	const boost::filesystem::path filename = dataPath("line_100.0_1000_300_1_Meter.ifc");
...
TEST_F(Line, ImageIsSaved)
{
	...
	// Act
	buw::storeImage(testPath("line_100.0_1000_300_1_Meter.png").string(), image);

	// Assert
	EXPECT_NO_THROW(buw::loadImage4b(testPath("line_100.0_1000_300_1_Meter.png").string()));
}

TEST_F(Line, PlaneSurfaceViews)
{
	// Arrange
	const auto expected_front = buw::loadImage4b(dataPath("line_100.0_1000_300_1_Meter_front.png").string());
	const auto expected_top = buw::loadImage4b(dataPath("line_100.0_1000_300_1_Meter_top.png").string());
	const auto expected_bottom = buw::loadImage4b(dataPath("line_100.0_1000_300_1_Meter_bottom.png").string());
	const auto expected_left = buw::loadImage4b(dataPath("line_100.0_1000_300_1_Meter_left.png").string());
	const auto expected_right = buw::loadImage4b(dataPath("line_100.0_1000_300_1_Meter_right.png").string());
	const auto expected_back = buw::loadImage4b(dataPath("line_100.0_1000_300_1_Meter_back.png").string());
	...
	/*
	buw::storeImage(testPath("line_100.0_1000_300_1_Meter_front.png").string(), image_front);
	buw::storeImage(testPath("line_100.0_1000_300_1_Meter_top.png").string(), image_top);
	buw::storeImage(testPath("line_100.0_1000_300_1_Meter_bottom.png").string(), image_bottom);
	buw::storeImage(testPath("line_100.0_1000_300_1_Meter_left.png").string(), image_left);
	buw::storeImage(testPath("line_100.0_1000_300_1_Meter_right.png").string(), image_right);
	buw::storeImage(testPath("line_100.0_1000_300_1_Meter_back.png").string(), image_back);
	*/
...
{
	// Arrange
	const auto expected_front_left_bottom = buw::loadImage4b(dataPath("line_100.0_1000_300_1_Meter_front_left_bottom.png").string());
	const auto expected_front_right_bottom = buw::loadImage4b(dataPath("line_100.0_1000_300_1_Meter_front_right_bottom.png").string());
	const auto expected_top_left_front = buw::loadImage4b(dataPath("line_100.0_1000_300_1_Meter_top_left_front.png").string());
	const auto expected_top_front_right = buw::loadImage4b(dataPath("line_100.0_1000_300_1_Meter_top_front_right.png").string());
	const auto expected_top_left_back = buw::loadImage4b(dataPath("line_100.0_1000_300_1_Meter_top_left_back.png").string());
	const auto expected_top_right_back = buw::loadImage4b(dataPath("line_100.0_1000_300_1_Meter_top_right_back.png").string());
	const auto expected_back_left_bottom = buw::loadImage4b(dataPath("line_100.0_1000_300_1_Meter_back_left_bottom.png").string());
	const auto expected_right_bottom_back = buw::loadImage4b(dataPath("line_100.0_1000_300_1_Meter_right_bottom_back.png").string());
	...
	// uncomment following lines to also save the screen shot
	/*
	buw::storeImage(testPath("line_100.0_1000_300_1_Meter_front_left_bottom.png").string(), image_front_left_bottom);
	buw::storeImage(testPath("line_100.0_1000_300_1_Meter_front_right_bottom.png").string(), image_front_right_bottom);
	buw::storeImage(testPath("line_100.0_1000_300_1_Meter_top_left_front.png").string(), image_top_left_front);
	buw::storeImage(testPath("line_100.0_1000_300_1_Meter_top_front_right.png").string(), image_top_front_right);
	buw::storeImage(testPath("line_100.0_1000_300_1_Meter_top_left_back.png").string(), image_top_left_back);
	buw::storeImage(testPath("line_100.0_1000_300_1_Meter_top_right_back.png").string(), image_top_right_back);
	buw::storeImage(testPath("line_100.0_1000_300_1_Meter_back_left_bottom.png").string(), image_back_left_bottom);
	buw::storeImage(testPath("line_100.0_1000_300_1_Meter_right_bottom_back.png").string(), image_right_bottom_back);
	*/
