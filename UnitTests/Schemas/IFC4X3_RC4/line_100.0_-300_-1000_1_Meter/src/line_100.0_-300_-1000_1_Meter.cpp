...
protected:
	...
	virtual std::string TestName() const { return "line_100.0_-300_-1000_1_Meter"; }
	virtual std::string Schema() const { return "IFC4X3_RC4"; }

	const boost::filesystem::path filename = dataPath("line_100.0_-300_-1000_1_Meter.ifc");
...
TEST_F(Line, ImageIsSaved)
{
	...
	// Act
	buw::storeImage(testPath("line_100.0_-300_-1000_1_Meter.png").string(), image);

	// Assert
	EXPECT_NO_THROW(buw::loadImage4b(testPath("line_100.0_-300_-1000_1_Meter.png").string()));
}

TEST_F(Line, PlaneSurfaceViews)
{
	// Arrange
	const auto expected_top = buw::loadImage4b(dataPath("line_100.0_-300_-1000_1_Meter_top.png").string());
	...
	//buw::storeImage(testPath("line_100.0_-300_-1000_1_Meter_top.png").string(), image_top);
