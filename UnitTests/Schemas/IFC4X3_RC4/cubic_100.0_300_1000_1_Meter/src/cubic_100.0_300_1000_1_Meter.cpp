...
class Cubic : public IfcVisualTest {
protected:
	...
	virtual std::string TestName() const { return "cubic_100.0_300_1000_1_Meter"; }
	virtual std::string Schema() const { return "IFC4X3_RC4"; }

	const boost::filesystem::path filename = dataPath("cubic_100.0_300_1000_1_Meter.ifc");
...
TEST_F(Cubic, ImageIsSaved)
{
	...
	// Act
	buw::storeImage(testPath("cubic_100.0_300_1000_1_Meter.png").string(), image);

	// Assert
	EXPECT_NO_THROW(buw::loadImage4b(testPath("cubic_100.0_300_1000_1_Meter.png").string()));
}

TEST_F(Cubic, PlaneSurfaceViews)
{
	// Arrange
	...
	buw::storeImage(testPath("cubic_100.0_300_1000_1_Meter_right.png").string(), image_right);
	buw::storeImage(testPath("cubic_100.0_300_1000_1_Meter_back.png").string(), image_back);
	*/
...
TEST_F(Cubic, VertexViews)
{
	// Arrange
	const auto expected_front_left_bottom = buw::loadImage4b(dataPath("cubic_100.0_300_1000_1_Meter_front_left_bottom.png").string());
	const auto expected_front_right_bottom = buw::loadImage4b(dataPath("cubic_100.0_300_1000_1_Meter_front_right_bottom.png").string());
	const auto expected_top_left_front = buw::loadImage4b(dataPath("cubic_100.0_300_1000_1_Meter_top_left_front.png").string());
	const auto expected_top_front_right = buw::loadImage4b(dataPath("cubic_100.0_300_1000_1_Meter_top_front_right.png").string());
	const auto expected_top_left_back = buw::loadImage4b(dataPath("cubic_100.0_300_1000_1_Meter_top_left_back.png").string());
	const auto expected_top_right_back = buw::loadImage4b(dataPath("cubic_100.0_300_1000_1_Meter_top_right_back.png").string());
	const auto expected_back_left_bottom = buw::loadImage4b(dataPath("cubic_100.0_300_1000_1_Meter_back_left_bottom.png").string());
	const auto expected_right_bottom_back = buw::loadImage4b(dataPath("cubic_100.0_300_1000_1_Meter_right_bottom_back.png").string());
	...
	// uncomment following lines to also save the screen shot
	/*
	buw::storeImage(testPath("cubic_100.0_300_1000_1_Meter_front_left_bottom.png").string(), image_front_left_bottom);
	buw::storeImage(testPath("cubic_100.0_300_1000_1_Meter_front_right_bottom.png").string(), image_front_right_bottom);
	buw::storeImage(testPath("cubic_100.0_300_1000_1_Meter_top_left_front.png").string(), image_top_left_front);
	buw::storeImage(testPath("cubic_100.0_300_1000_1_Meter_top_front_right.png").string(), image_top_front_right);
	buw::storeImage(testPath("cubic_100.0_300_1000_1_Meter_top_left_back.png").string(), image_top_left_back);
	buw::storeImage(testPath("cubic_100.0_300_1000_1_Meter_top_right_back.png").string(), image_top_right_back);
	buw::storeImage(testPath("cubic_100.0_300_1000_1_Meter_back_left_bottom.png").string(), image_back_left_bottom);
	buw::storeImage(testPath("cubic_100.0_300_1000_1_Meter_right_bottom_back.png").string(), image_right_bottom_back);
	*/
