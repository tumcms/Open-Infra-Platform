...
class SSH_Curve1 : public VisualTest {
	...
	const boost::filesystem::path filename = dataPath("SSH-Curve_1.ifc");
...
TEST_F(SSH_Curve1, AllEntitiesAreRead) {
	EXPECT_THAT(express_model->entities.size(), Eq(47));
}

TEST_F(SSH_Curve1, IFCHasAnEssentialEntity) {
...
TEST_F(SSH_Curve1, ImageIsSaved)
{
	// Arrange
	buw::Image4b image = CaptureImage();

	// Act
	buw::storeImage(testPath("SSH-Curve_1.png").string(), image);

	// Assert
	EXPECT_NO_THROW(buw::loadImage4b(testPath("SSH-Curve_1.png").string()));
}

TEST_F(SSH_Curve1, PlaneSurfaceViews)
{
	// Arrange
	const auto expected_front = buw::loadImage4b(dataPath("SSH-Curve_1_front.png").string());
	const auto expected_top = buw::loadImage4b(dataPath("SSH-Curve_1_top.png").string());
	const auto expected_bottom = buw::loadImage4b(dataPath("SSH-Curve_1_bottom.png").string());
	const auto expected_left = buw::loadImage4b(dataPath("SSH-Curve_1_left.png").string());
	const auto expected_right = buw::loadImage4b(dataPath("SSH-Curve_1_right.png").string());
	const auto expected_back = buw::loadImage4b(dataPath("SSH-Curve_1_back.png").string());
	...
	/*
	buw::storeImage(testPath("SSH-Curve_1_front.png").string(), image_front);
	buw::storeImage(testPath("SSH-Curve_1_top.png").string(), image_top);
	buw::storeImage(testPath("SSH-Curve_1_bottom.png").string(), image_bottom);
	buw::storeImage(testPath("SSH-Curve_1_left.png").string(), image_left);
	buw::storeImage(testPath("SSH-Curve_1_right.png").string(), image_right);
	buw::storeImage(testPath("SSH-Curve_1_back.png").string(), image_back);
	*/
...
TEST_F(SSH_Curve1, VertexViews)
{
	// Arrange
	const auto expected_front_left_bottom = buw::loadImage4b(dataPath("SSH-Curve_1_front_left_bottom.png").string());
	const auto expected_front_right_bottom = buw::loadImage4b(dataPath("SSH-Curve_1_front_right_bottom.png").string());
	const auto expected_top_left_front = buw::loadImage4b(dataPath("SSH-Curve_1_top_left_front.png").string());
	const auto expected_top_front_right = buw::loadImage4b(dataPath("SSH-Curve_1_top_front_right.png").string());
	const auto expected_top_left_back = buw::loadImage4b(dataPath("SSH-Curve_1_top_left_back.png").string());
	const auto expected_top_right_back = buw::loadImage4b(dataPath("SSH-Curve_1_top_right_back.png").string());
	const auto expected_back_left_bottom = buw::loadImage4b(dataPath("SSH-Curve_1_back_left_bottom.png").string());
	const auto expected_right_bottom_back = buw::loadImage4b(dataPath("SSH-Curve_1_right_bottom_back.png").string());
	...
	// uncomment following lines to also save the screen shot
	/*
	buw::storeImage(testPath("SSH-Curve_1_front_left_bottom.png").string(), image_front_left_bottom);
	buw::storeImage(testPath("SSH-Curve_1_front_right_bottom.png").string(), image_front_right_bottom);
	buw::storeImage(testPath("SSH-Curve_1_top_left_front.png").string(), image_top_left_front);
	buw::storeImage(testPath("SSH-Curve_1_top_front_right.png").string(), image_top_front_right);
	buw::storeImage(testPath("SSH-Curve_1_top_left_back.png").string(), image_top_left_back);
	buw::storeImage(testPath("SSH-Curve_1_top_right_back.png").string(), image_top_right_back);
	buw::storeImage(testPath("SSH-Curve_1_back_left_bottom.png").string(), image_back_left_bottom);
	buw::storeImage(testPath("SSH-Curve_1_right_bottom_back.png").string(), image_right_bottom_back);
	*/
