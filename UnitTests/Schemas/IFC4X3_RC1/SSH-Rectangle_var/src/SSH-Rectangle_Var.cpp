...
class SSHRectangleVarTest : public IfcVisualTest {
	protected:
	...
	virtual std::string TestName() const { return "SSH-Rectangle_Var"; }
	virtual std::string Schema() const { return "IFC4X3_RC1"; }

	const boost::filesystem::path filename = dataPath("SSH-Rectangle_Var.ifc");
...
TEST_F(SSHRectangleVarTest, AllEntitiesAreRead) {
	EXPECT_THAT(express_model->entities.size(), Eq(46));
}

TEST_F(SSHRectangleVarTest, IFCHasAnEssentialEntity) {
...
TEST_F(SSHRectangleVarTest, ImageIsSaved)
{
	// Arrange
	buw::Image4b image = CaptureImage();

	// Act
	buw::storeImage(testPath("SSH-Rectangle_Var.png").string(), image);

	// Assert
	EXPECT_NO_THROW(buw::loadImage4b(testPath("SSH-Rectangle_Var.png").string()));
}

TEST_F(SSHRectangleVarTest, PlaneSurfaceViews)
{
	// Arrange
	const auto expected_front = buw::loadImage4b(dataPath("SSH-Rectangle_Var_front.png").string());
	const auto expected_top = buw::loadImage4b(dataPath("SSH-Rectangle_Var_top.png").string());
	const auto expected_bottom = buw::loadImage4b(dataPath("SSH-Rectangle_Var_bottom.png").string());
	const auto expected_left = buw::loadImage4b(dataPath("SSH-Rectangle_Var_left.png").string());
	const auto expected_right = buw::loadImage4b(dataPath("SSH-Rectangle_Var_right.png").string());
	const auto expected_back = buw::loadImage4b(dataPath("SSH-Rectangle_Var_back.png").string());
	...
	/*
	buw::storeImage(testPath("SSH-Rectangle_Var_front.png").string(), image_front);
	buw::storeImage(testPath("SSH-Rectangle_Var_top.png").string(), image_top);
	buw::storeImage(testPath("SSH-Rectangle_Var_bottom.png").string(), image_bottom);
	buw::storeImage(testPath("SSH-Rectangle_Var_left.png").string(), image_left);
	buw::storeImage(testPath("SSH-Rectangle_Var_right.png").string(), image_right);
	buw::storeImage(testPath("SSH-Rectangle_Var_back.png").string(), image_back);
	*/
...
TEST_F(SSHRectangleVarTest, VertexViews)
{
	// Arrange
	const auto expected_front_left_bottom = buw::loadImage4b(dataPath("SSH-Rectangle_Var_front_left_bottom.png").string());
	const auto expected_front_right_bottom = buw::loadImage4b(dataPath("SSH-Rectangle_Var_front_right_bottom.png").string());
	const auto expected_top_left_front = buw::loadImage4b(dataPath("SSH-Rectangle_Var_top_left_front.png").string());
	const auto expected_top_front_right = buw::loadImage4b(dataPath("SSH-Rectangle_Var_top_front_right.png").string());
	const auto expected_top_left_back = buw::loadImage4b(dataPath("SSH-Rectangle_Var_top_left_back.png").string());
	const auto expected_top_right_back = buw::loadImage4b(dataPath("SSH-Rectangle_Var_top_right_back.png").string());
	const auto expected_back_left_bottom = buw::loadImage4b(dataPath("SSH-Rectangle_Var_back_left_bottom.png").string());
	const auto expected_right_bottom_back = buw::loadImage4b(dataPath("SSH-Rectangle_Var_right_bottom_back.png").string());
	...
	// uncomment following lines to also save the screen shot
	/*
	buw::storeImage(testPath("SSH-Rectangle_Var_front_left_bottom.png").string(), image_front_left_bottom);
	buw::storeImage(testPath("SSH-Rectangle_Var_front_right_bottom.png").string(), image_front_right_bottom);
	buw::storeImage(testPath("SSH-Rectangle_Var_top_left_front.png").string(), image_top_left_front);
	buw::storeImage(testPath("SSH-Rectangle_Var_top_front_right.png").string(), image_top_front_right);
	buw::storeImage(testPath("SSH-Rectangle_Var_top_left_back.png").string(), image_top_left_back);
	buw::storeImage(testPath("SSH-Rectangle_Var_top_right_back.png").string(), image_top_right_back);
	buw::storeImage(testPath("SSH-Rectangle_Var_back_left_bottom.png").string(), image_back_left_bottom);
	buw::storeImage(testPath("SSH-Rectangle_Var_right_bottom_back.png").string(), image_right_bottom_back);
	*/
