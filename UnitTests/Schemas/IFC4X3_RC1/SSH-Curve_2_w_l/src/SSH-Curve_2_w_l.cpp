...
class SSH_Curve2_w_l : public IfcVisualTest {
	protected:
	...
	virtual std::string TestName() const { return "SSH-Curve_2_w_l"; }
	virtual std::string Schema() const { return "IFC4X3_RC1"; }

	const boost::filesystem::path filename = dataPath("SSH-Curve_2_w_l.ifc");
...
TEST_F(SSH_Curve2_w_l, AllEntitiesAreRead) {
	EXPECT_THAT(express_model->entities.size(), Eq(62));
}

TEST_F(SSH_Curve2_w_l, IFCHasAnEssentialEntity) {
...
TEST_F(SSH_Curve2_w_l, ImageIsSaved)
{
	// Arrange
	buw::Image4b image = CaptureImage();

	// Act
	buw::storeImage(testPath("SSH-Curve_2_w_l.png").string(), image);

	// Assert
	EXPECT_NO_THROW(buw::loadImage4b(testPath("SSH-Curve_2_w_l.png").string()));
}

TEST_F(SSH_Curve2_w_l, PlaneSurfaceViews)
{
	// Arrange
	const auto expected_front = buw::loadImage4b(dataPath("SSH-Curve_2_w_l_front.png").string());
	const auto expected_top = buw::loadImage4b(dataPath("SSH-Curve_2_w_l_top.png").string());
	const auto expected_bottom = buw::loadImage4b(dataPath("SSH-Curve_2_w_l_bottom.png").string());
	const auto expected_left = buw::loadImage4b(dataPath("SSH-Curve_2_w_l_left.png").string());
	const auto expected_right = buw::loadImage4b(dataPath("SSH-Curve_2_w_l_right.png").string());
	const auto expected_back = buw::loadImage4b(dataPath("SSH-Curve_2_w_l_back.png").string());
	...
	/*buw::storeImage(testPath("SSH-Curve_2_w_l_front.png").string(), image_front);
	buw::storeImage(testPath("SSH-Curve_2_w_l_top.png").string(), image_top);
	buw::storeImage(testPath("SSH-Curve_2_w_l_bottom.png").string(), image_bottom);
	buw::storeImage(testPath("SSH-Curve_2_w_l_left.png").string(), image_left);
	buw::storeImage(testPath("SSH-Curve_2_w_l_right.png").string(), image_right);
	buw::storeImage(testPath("SSH-Curve_2_w_l_back.png").string(), image_back);
	*/
...
TEST_F(SSH_Curve2_w_l, VertexViews)
{
	// Arrange
	const auto expected_front_left_bottom = buw::loadImage4b(dataPath("SSH-Curve_2_w_l_front_left_bottom.png").string());
	const auto expected_front_right_bottom = buw::loadImage4b(dataPath("SSH-Curve_2_w_l_front_right_bottom.png").string());
	const auto expected_top_left_front = buw::loadImage4b(dataPath("SSH-Curve_2_w_l_top_left_front.png").string());
	const auto expected_top_front_right = buw::loadImage4b(dataPath("SSH-Curve_2_w_l_top_front_right.png").string());
	const auto expected_top_left_back = buw::loadImage4b(dataPath("SSH-Curve_2_w_l_top_left_back.png").string());
	const auto expected_top_right_back = buw::loadImage4b(dataPath("SSH-Curve_2_w_l_top_right_back.png").string());
	const auto expected_back_left_bottom = buw::loadImage4b(dataPath("SSH-Curve_2_w_l_back_left_bottom.png").string());
	const auto expected_right_bottom_back = buw::loadImage4b(dataPath("SSH-Curve_2_w_l_right_bottom_back.png").string());
	...
	// uncomment following lines to also save the screen shot
	/*
	buw::storeImage(testPath("SSH-Curve_2_w_l_front_left_bottom.png").string(), image_front_left_bottom);
	buw::storeImage(testPath("SSH-Curve_2_w_l_front_right_bottom.png").string(), image_front_right_bottom);
	buw::storeImage(testPath("SSH-Curve_2_w_l_top_left_front.png").string(), image_top_left_front);
	buw::storeImage(testPath("SSH-Curve_2_w_l_top_front_right.png").string(), image_top_front_right);
	buw::storeImage(testPath("SSH-Curve_2_w_l_top_left_back.png").string(), image_top_left_back);
	buw::storeImage(testPath("SSH-Curve_2_w_l_top_right_back.png").string(), image_top_right_back);
	buw::storeImage(testPath("SSH-Curve_2_w_l_back_left_bottom.png").string(), image_back_left_bottom);
	buw::storeImage(testPath("SSH-Curve_2_w_l_right_bottom_back.png").string(), image_right_bottom_back);
	*/
