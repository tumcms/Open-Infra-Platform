...
class SectionedSolid : public IfcVisualTest {
protected:
	...
	virtual std::string TestName() const { return "sectioned-solid"; }
	virtual std::string Schema() const { return "IFC4x1"; }

	const boost::filesystem::path filename = dataPath("sectioned-solid.ifc");
...
/*
TEST_F(SectionedSolid, AllEntitiesAreRead) {
	EXPECT_THAT(express_model->entities.size(), Eq(628));
}

TEST_F(SectionedSolid, IFCHasAnEssentialEntity) {
...
TEST_F(SectionedSolid, CountEssentialEntities) {
...
*/
/*
TEST_F(SectionedSolid, ImageIsSaved)
{
	// Arrange
	buw::Image4b image = rendererIfc->captureImage();

	// Act
	buw::storeImage(testPath("sectioned-solid.png").string(), image);

	// Assert
	EXPECT_NO_THROW(buw::loadImage4b(testPath("sectioned-solid.png").string()));
}

TEST_F(SectionedSolid, PlaneSurfaceViews)
{
	// Arrange
	const auto expected_front = buw::loadImage4b(dataPath("sectioned-solid_front.png").string());
	const auto expected_top = buw::loadImage4b(dataPath("sectioned-solid_top.png").string());
	const auto expected_bottom = buw::loadImage4b(dataPath("sectioned-solid_bottom.png").string());
	const auto expected_left = buw::loadImage4b(dataPath("sectioned-solid_left.png").string());
	const auto expected_right = buw::loadImage4b(dataPath("sectioned-solid_right.png").string());
	const auto expected_back = buw::loadImage4b(dataPath("sectioned-solid_back.png").string());
	...
	buw::storeImage(testPath("sectioned-solid_front.png").string(), image_front);
	buw::storeImage(testPath("sectioned-solid_top.png").string(), image_top);
	buw::storeImage(testPath("sectioned-solid_bottom.png").string(), image_bottom);
	buw::storeImage(testPath("sectioned-solid_left.png").string(), image_left);
	buw::storeImage(testPath("sectioned-solid_right.png").string(), image_right);
	buw::storeImage(testPath("sectioned-solid_back.png").string(), image_back);
...
TEST_F(SectionedSolid, VertexViews)
{
	// Arrange
	const auto expected_front_left_bottom = buw::loadImage4b(dataPath("sectioned-solid_front_left_bottom.png").string());
	const auto expected_front_right_bottom = buw::loadImage4b(dataPath("sectioned-solid_front_right_bottom.png").string());
	const auto expected_top_left_front = buw::loadImage4b(dataPath("sectioned-solid_top_left_front.png").string());
	const auto expected_top_front_right = buw::loadImage4b(dataPath("sectioned-solid_top_front_right.png").string());
	const auto expected_top_left_back = buw::loadImage4b(dataPath("sectioned-solid_top_left_back.png").string());
	const auto expected_top_right_back = buw::loadImage4b(dataPath("sectioned-solid_top_right_back.png").string());
	const auto expected_back_left_bottom = buw::loadImage4b(dataPath("sectioned-solid_back_left_bottom.png").string());
	const auto expected_right_bottom_back = buw::loadImage4b(dataPath("sectioned-solid_right_bottom_back.png").string());
	...
	buw::storeImage(testPath("sectioned-solid_front_left_bottom.png").string(), image_front_left_bottom);
	buw::storeImage(testPath("sectioned-solid_front_right_bottom.png").string(), image_front_right_bottom);
	buw::storeImage(testPath("sectioned-solid_top_left_front.png").string(), image_top_left_front);
	buw::storeImage(testPath("sectioned-solid_top_front_right.png").string(), image_top_front_right);
	buw::storeImage(testPath("sectioned-solid_top_left_back.png").string(), image_top_left_back);
	buw::storeImage(testPath("sectioned-solid_top_right_back.png").string(), image_top_right_back);
	buw::storeImage(testPath("sectioned-solid_back_left_bottom.png").string(), image_back_left_bottom);
	buw::storeImage(testPath("sectioned-solid_right_bottom_back.png").string(), image_right_bottom_back);
