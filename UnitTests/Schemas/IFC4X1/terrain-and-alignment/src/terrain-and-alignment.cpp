...
class TerrainAndAlignment : public IfcVisualTest {
protected:
	...
	virtual std::string TestName() const { return "terrain-and-alignment"; }
	virtual std::string Schema() const { return "IFC4x1"; }

	const boost::filesystem::path filename = dataPath("terrain-and-alignment.ifc");
...
TEST_F(TerrainAndAlignment, AllEntitiesAreRead) {
	EXPECT_THAT(express_model->entities.size(), Eq(191));
}

TEST_F(TerrainAndAlignment, IFCHasAnEssentialEntity) {
...
TEST_F(TerrainAndAlignment, CountEssentialEntities) {
	...
	auto result4 = std::count_if(express_model->entities.begin(), express_model->entities.end(), [](auto &pair) -> bool { return pair.second->classname() == "IFCALIGNMENT2DVERTICAL"; });
...
TEST_F(TerrainAndAlignment, ImageIsSaved)
{
	...
	// Act
	buw::storeImage(testPath("terrain-and-alignment.png").string(), image);

	// Assert
	EXPECT_NO_THROW(buw::loadImage4b(testPath("terrain-and-alignment.png").string()));
}

TEST_F(TerrainAndAlignment, PlaneSurfaceViews)
{
	// Arrange
	const auto expected_front = buw::loadImage4b(dataPath("terrain-and-alignment_front.png").string());
	const auto expected_top = buw::loadImage4b(dataPath("terrain-and-alignment_top.png").string());
	const auto expected_bottom = buw::loadImage4b(dataPath("terrain-and-alignment_bottom.png").string());
	const auto expected_left = buw::loadImage4b(dataPath("terrain-and-alignment_left.png").string());
	const auto expected_right = buw::loadImage4b(dataPath("terrain-and-alignment_right.png").string());
	const auto expected_back = buw::loadImage4b(dataPath("terrain-and-alignment_back.png").string());
	...
	buw::storeImage(testPath("terrain-and-alignment_front.png").string(), image_front);
	buw::storeImage(testPath("terrain-and-alignment_top.png").string(), image_top);
	buw::storeImage(testPath("terrain-and-alignment_bottom.png").string(), image_bottom);
	buw::storeImage(testPath("terrain-and-alignment_left.png").string(), image_left);
	buw::storeImage(testPath("terrain-and-alignment_right.png").string(), image_right);
	buw::storeImage(testPath("terrain-and-alignment_back.png").string(), image_back);
...
TEST_F(TerrainAndAlignment, VertexViews)
{
	// Arrange
	const auto expected_front_left_bottom = buw::loadImage4b(dataPath("terrain-and-alignment_front_left_bottom.png").string());
	const auto expected_front_right_bottom = buw::loadImage4b(dataPath("terrain-and-alignment_front_right_bottom.png").string());
	const auto expected_top_left_front = buw::loadImage4b(dataPath("terrain-and-alignment_top_left_front.png").string());
	const auto expected_top_front_right = buw::loadImage4b(dataPath("terrain-and-alignment_top_front_right.png").string());
	const auto expected_top_left_back = buw::loadImage4b(dataPath("terrain-and-alignment_top_left_back.png").string());
	const auto expected_top_right_back = buw::loadImage4b(dataPath("terrain-and-alignment_top_right_back.png").string());
	const auto expected_back_left_bottom = buw::loadImage4b(dataPath("terrain-and-alignment_back_left_bottom.png").string());
	const auto expected_right_bottom_back = buw::loadImage4b(dataPath("terrain-and-alignment_right_bottom_back.png").string());
	...
	buw::storeImage(testPath("terrain-and-alignment_front_left_bottom.png").string(), image_front_left_bottom);
	buw::storeImage(testPath("terrain-and-alignment_front_right_bottom.png").string(), image_front_right_bottom);
	buw::storeImage(testPath("terrain-and-alignment_top_left_front.png").string(), image_top_left_front);
	buw::storeImage(testPath("terrain-and-alignment_top_front_right.png").string(), image_top_front_right);
	buw::storeImage(testPath("terrain-and-alignment_top_left_back.png").string(), image_top_left_back);
	buw::storeImage(testPath("terrain-and-alignment_top_right_back.png").string(), image_top_right_back);
	buw::storeImage(testPath("terrain-and-alignment_back_left_bottom.png").string(), image_back_left_bottom);
	buw::storeImage(testPath("terrain-and-alignment_right_bottom_back.png").string(), image_right_bottom_back);
