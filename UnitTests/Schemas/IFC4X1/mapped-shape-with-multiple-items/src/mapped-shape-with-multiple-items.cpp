...
class MappedShapeWithMultipleItems : public IfcVisualTest {
protected:
	...
	virtual std::string TestName() const { return "mapped-shape-with-multiple-items"; }
	virtual std::string Schema() const { return "IFC4X1"; }

	const boost::filesystem::path filename = dataPath("mapped-shape-with-multiple-items.ifc");

	std::shared_ptr<oip::EXPRESSModel> express_model = nullptr;
	buw::ReferenceCounted<oip::IfcImporterT<emt::IFC4X1EntityTypes>> importer = nullptr;
};

TEST_F(MappedShapeWithMultipleItems, AllEntitiesAreRead) {
...
TEST_F(MappedShapeWithMultipleItems, ImageIsSaved)
{
	...
	// Act
	buw::storeImage(testPath("mapped-shape-with-multiple-items.png").string(), image);

	// Assert
	EXPECT_NO_THROW(buw::loadImage4b(testPath("mapped-shape-with-multiple-items.png").string()));
}

TEST_F(MappedShapeWithMultipleItems, PlaneSurfaceViews)
{
	// Arrange
	const auto expected_front = buw::loadImage4b(dataPath("mapped-shape-with-multiple-items_front.png").string());
	const auto expected_top = buw::loadImage4b(dataPath("mapped-shape-with-multiple-items_top.png").string());
	const auto expected_bottom = buw::loadImage4b(dataPath("mapped-shape-with-multiple-items_bottom.png").string());
	const auto expected_left = buw::loadImage4b(dataPath("mapped-shape-with-multiple-items_left.png").string());
	const auto expected_right = buw::loadImage4b(dataPath("mapped-shape-with-multiple-items_right.png").string());
	const auto expected_back = buw::loadImage4b(dataPath("mapped-shape-with-multiple-items_back.png").string());
	...
	/*
	buw::storeImage(testPath("mapped-shape-with-multiple-items_front.png").string(), image_front);
	buw::storeImage(testPath("mapped-shape-with-multiple-items_top.png").string(), image_top);
	buw::storeImage(testPath("mapped-shape-with-multiple-items_bottom.png").string(), image_bottom);
	buw::storeImage(testPath("mapped-shape-with-multiple-items_left.png").string(), image_left);
	buw::storeImage(testPath("mapped-shape-with-multiple-items_right.png").string(), image_right);
	buw::storeImage(testPath("mapped-shape-with-multiple-items_back.png").string(), image_back);
	*/
...
TEST_F(MappedShapeWithMultipleItems, VertexViews)
{
	// Arrange
	const auto expected_front_left_bottom = buw::loadImage4b(dataPath("mapped-shape-with-multiple-items_front_left_bottom.png").string());
	const auto expected_front_right_bottom = buw::loadImage4b(dataPath("mapped-shape-with-multiple-items_front_right_bottom.png").string());
	const auto expected_top_left_front = buw::loadImage4b(dataPath("mapped-shape-with-multiple-items_top_left_front.png").string());
	const auto expected_top_front_right = buw::loadImage4b(dataPath("mapped-shape-with-multiple-items_top_front_right.png").string());
	const auto expected_top_left_back = buw::loadImage4b(dataPath("mapped-shape-with-multiple-items_top_left_back.png").string());
	const auto expected_top_right_back = buw::loadImage4b(dataPath("mapped-shape-with-multiple-items_top_right_back.png").string());
	const auto expected_back_left_bottom = buw::loadImage4b(dataPath("mapped-shape-with-multiple-items_back_left_bottom.png").string());
	const auto expected_right_bottom_back = buw::loadImage4b(dataPath("mapped-shape-with-multiple-items_right_bottom_back.png").string());
	...
	// uncomment following lines to also save the screen shot
	/*
	buw::storeImage(testPath("mapped-shape-with-multiple-items_front_left_bottom.png").string(), image_front_left_bottom);
	buw::storeImage(testPath("mapped-shape-with-multiple-items_front_right_bottom.png").string(), image_front_right_bottom);
	buw::storeImage(testPath("mapped-shape-with-multiple-items_top_left_front.png").string(), image_top_left_front);
	buw::storeImage(testPath("mapped-shape-with-multiple-items_top_front_right.png").string(), image_top_front_right);
	buw::storeImage(testPath("mapped-shape-with-multiple-items_top_left_back.png").string(), image_top_left_back);
	buw::storeImage(testPath("mapped-shape-with-multiple-items_top_right_back.png").string(), image_top_right_back);
	buw::storeImage(testPath("mapped-shape-with-multiple-items_back_left_bottom.png").string(), image_back_left_bottom);
	buw::storeImage(testPath("mapped-shape-with-multiple-items_right_bottom_back.png").string(), image_right_bottom_back);
	*/
