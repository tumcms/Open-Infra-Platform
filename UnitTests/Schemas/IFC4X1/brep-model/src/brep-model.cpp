...
class BrepModel : public IfcVisualTest {
protected:
	...
	virtual std::string TestName() const { return "brep-model"; }
	virtual std::string Schema() const { return "IFC4x1"; }

	const boost::filesystem::path filename = dataPath("brep-model.ifc");
...
TEST_F(BrepModel, IFCHasAnEssentialEntity) {
...
TEST_F(BrepModel, ImageIsSaved)
{
	...
	// Act
	buw::storeImage(testPath("brep-model.png").string(), image);
...
TEST_F(BrepModel, PlaneSurfaceViews)
{
	...
	const auto expected_top = buw::loadImage4b(dataPath("brep-model_top.png").string());
	const auto expected_bottom = buw::loadImage4b(dataPath("brep-model_bottom.png").string());
	const auto expected_left = buw::loadImage4b(dataPath("brep-model_left.png").string());
	const auto expected_right = buw::loadImage4b(dataPath("brep-model_right.png").string());
	const auto expected_back = buw::loadImage4b(dataPath("brep-model_back.png").string());
...
TEST_F(BrepModel, VertexViews)
{
	...
	const auto expected_front_right_bottom = buw::loadImage4b(dataPath("brep-model_front_right_bottom.png").string());
	const auto expected_top_left_front = buw::loadImage4b(dataPath("brep-model_top_left_front.png").string());
	const auto expected_top_front_right = buw::loadImage4b(dataPath("brep-model_top_front_right.png").string());
	const auto expected_top_left_back = buw::loadImage4b(dataPath("brep-model_top_left_back.png").string());
	const auto expected_top_right_back = buw::loadImage4b(dataPath("brep-model_top_right_back.png").string());
	const auto expected_back_left_bottom = buw::loadImage4b(dataPath("brep-model_back_left_bottom.png").string());
	const auto expected_right_bottom_back = buw::loadImage4b(dataPath("brep-model_right_bottom_back.png").string());
	...
	buw::storeImage(testPath("brep-model_top_front_right.png").string(), image_top_front_right);
	buw::storeImage(testPath("brep-model_top_left_back.png").string(), image_top_left_back);
