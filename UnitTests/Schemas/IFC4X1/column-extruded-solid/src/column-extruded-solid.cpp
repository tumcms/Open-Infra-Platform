...
class ColumnExtrudedSolid : public IfcVisualTest {
protected:
...
TEST_F(ColumnExtrudedSolid, ImageIsSaved)
{
	...
	// Act
	buw::storeImage(testPath("column-extruded-solid.png").string(), image);

	// Assert
	EXPECT_NO_THROW(buw::loadImage4b(testPath("column-extruded-solid.png").string()));
}

TEST_F(ColumnExtrudedSolid, PlaneSurfaceViews)
{
	// Arrange
	const auto expected_front = buw::loadImage4b(dataPath("column-extruded-solid_front.png").string());
	const auto expected_top = buw::loadImage4b(dataPath("column-extruded-solid_top.png").string());
	const auto expected_bottom = buw::loadImage4b(dataPath("column-extruded-solid_bottom.png").string());
	const auto expected_left = buw::loadImage4b(dataPath("column-extruded-solid_left.png").string());
	const auto expected_right = buw::loadImage4b(dataPath("column-extruded-solid_right.png").string());
	const auto expected_back = buw::loadImage4b(dataPath("column-extruded-solid_back.png").string());
	...
	/*
	buw::storeImage(testPath("column-extruded-solid_front.png").string(), image_front);
	buw::storeImage(testPath("column-extruded-solid_top.png").string(), image_top);
	buw::storeImage(testPath("column-extruded-solid_bottom.png").string(), image_bottom);
	buw::storeImage(testPath("column-extruded-solid_left.png").string(), image_left);
	buw::storeImage(testPath("column-extruded-solid_right.png").string(), image_right);
	buw::storeImage(testPath("column-extruded-solid_back.png").string(), image_back);
	*/
...
TEST_F(ColumnExtrudedSolid, VertexViews)
{
	// Arrange
	const auto expected_front_left_bottom = buw::loadImage4b(dataPath("column-extruded-solid_front_left_bottom.png").string());
	const auto expected_front_right_bottom = buw::loadImage4b(dataPath("column-extruded-solid_front_right_bottom.png").string());
	const auto expected_top_left_front = buw::loadImage4b(dataPath("column-extruded-solid_top_left_front.png").string());
	const auto expected_top_front_right = buw::loadImage4b(dataPath("column-extruded-solid_top_front_right.png").string());
	const auto expected_top_left_back = buw::loadImage4b(dataPath("column-extruded-solid_top_left_back.png").string());
	const auto expected_top_right_back = buw::loadImage4b(dataPath("column-extruded-solid_top_right_back.png").string());
	const auto expected_back_left_bottom = buw::loadImage4b(dataPath("column-extruded-solid_back_left_bottom.png").string());
	const auto expected_right_bottom_back = buw::loadImage4b(dataPath("column-extruded-solid_right_bottom_back.png").string());
	...
	// uncomment following lines to also save the screen shot
	/*
	buw::storeImage(testPath("column-extruded-solid_front_left_bottom.png").string(), image_front_left_bottom);
	buw::storeImage(testPath("column-extruded-solid_front_right_bottom.png").string(), image_front_right_bottom);
	buw::storeImage(testPath("column-extruded-solid_top_left_front.png").string(), image_top_left_front);
	buw::storeImage(testPath("column-extruded-solid_top_front_right.png").string(), image_top_front_right);
	buw::storeImage(testPath("column-extruded-solid_top_left_back.png").string(), image_top_left_back);
	buw::storeImage(testPath("column-extruded-solid_top_right_back.png").string(), image_top_right_back);
	buw::storeImage(testPath("column-extruded-solid_back_left_bottom.png").string(), image_back_left_bottom);
	buw::storeImage(testPath("column-extruded-solid_right_bottom_back.png").string(), image_right_bottom_back);
	*/
