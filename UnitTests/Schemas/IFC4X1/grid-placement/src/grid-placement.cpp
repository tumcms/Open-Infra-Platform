...
class GridPlacement : public IfcVisualTest {
protected:
	...
	virtual std::string TestName() const { return "grid-placement"; }
	virtual std::string Schema() const { return "IFC4X1"; }

	const boost::filesystem::path filename = dataPath("grid-placement.ifc");
...
TEST_F(GridPlacement, AllEntitiesAreRead) {
	EXPECT_THAT(express_model->entities.size(), Eq(523));
}

TEST_F(GridPlacement, IFCHasAnEssentialEntity) {
	...
	auto result2 = std::find_if(express_model->entities.begin(), express_model->entities.end(), [](auto &pair) -> bool { return pair.second->classname() == "IFCRECTANGLEPROFILEDEF"; });
	auto result3 = std::find_if(express_model->entities.begin(), express_model->entities.end(), [](auto &pair) -> bool { return pair.second->classname() == "IFCGRIDAXIS"; });
	auto result4 = std::find_if(express_model->entities.begin(), express_model->entities.end(), [](auto &pair) -> bool { return pair.second->classname() == "IFCVIRTUALGRIDINTERSECTION"; });
	auto result5 = std::find_if(express_model->entities.begin(), express_model->entities.end(), [](auto &pair) -> bool { return pair.second->classname() == "IFCGRIDPLACEMENT"; });
...
TEST_F(GridPlacement, CountEssentialEntities) {
	...
	auto result3 = std::count_if(express_model->entities.begin(), express_model->entities.end(), [](auto &pair) -> bool { return pair.second->classname() == "IFCGRIDAXIS"; });
	auto result4 = std::count_if(express_model->entities.begin(), express_model->entities.end(), [](auto &pair) -> bool { return pair.second->classname() == "IFCVIRTUALGRIDINTERSECTION"; });
	auto result5 = std::count_if(express_model->entities.begin(), express_model->entities.end(), [](auto &pair) -> bool { return pair.second->classname() == "IFCGRIDPLACEMENT"; });

	EXPECT_EQ(result1, 35);
	EXPECT_EQ(result2, 35);
	EXPECT_EQ(result3, 10);
	EXPECT_EQ(result4, 25);
...
TEST_F(GridPlacement, ImageIsSaved)
{
	...
	// Act
	buw::storeImage(testPath("grid-placement.png").string(), image);

	// Assert
	EXPECT_NO_THROW(buw::loadImage4b(testPath("grid-placement.png").string()));
}

TEST_F(GridPlacement, PlaneSurfaceViews)
{
	// Arrange
	const auto expected_front = buw::loadImage4b(dataPath("grid-placement_front.png").string());
	const auto expected_top = buw::loadImage4b(dataPath("grid-placement_top.png").string());
	const auto expected_bottom = buw::loadImage4b(dataPath("grid-placement_bottom.png").string());
	const auto expected_left = buw::loadImage4b(dataPath("grid-placement_left.png").string());
	const auto expected_right = buw::loadImage4b(dataPath("grid-placement_right.png").string());
	const auto expected_back = buw::loadImage4b(dataPath("grid-placement_back.png").string());
...
TEST_F(GridPlacement, VertexViews)
{
	// Arrange
	const auto expected_front_left_bottom = buw::loadImage4b(dataPath("grid-placement_front_left_bottom.png").string());
	const auto expected_front_right_bottom = buw::loadImage4b(dataPath("grid-placement_front_right_bottom.png").string());
	const auto expected_top_left_front = buw::loadImage4b(dataPath("grid-placement_top_left_front.png").string());
	const auto expected_top_front_right = buw::loadImage4b(dataPath("grid-placement_top_front_right.png").string());
	const auto expected_top_left_back = buw::loadImage4b(dataPath("grid-placement_top_left_back.png").string());
	const auto expected_top_right_back = buw::loadImage4b(dataPath("grid-placement_top_right_back.png").string());
	const auto expected_back_left_bottom = buw::loadImage4b(dataPath("grid-placement_back_left_bottom.png").string());
	const auto expected_right_bottom_back = buw::loadImage4b(dataPath("grid-placement_right_bottom_back.png").string());
	...
	buw::storeImage(testPath("grid-placement_top_front_right.png").string(), image_top_front_right);
	buw::storeImage(testPath("grid-placement_top_left_back.png").string(), image_top_left_back);
