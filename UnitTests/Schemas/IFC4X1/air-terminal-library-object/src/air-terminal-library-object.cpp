...
class AirTerminalLibraryObject : public IfcVisualTest {
protected:
...
TEST_F(AirTerminalLibraryObject, ImageIsSaved)
{
	...
	// Act
	buw::storeImage(testPath("air-terminal-library-object.png").string(), image);

	// Assert
	EXPECT_NO_THROW(buw::loadImage4b(testPath("air-terminal-library-object.png").string()));
}

TEST_F(AirTerminalLibraryObject, PlaneSurfaceViews)
{
	// Arrange
	const auto expected_front = buw::loadImage4b(dataPath("air-terminal-library-object_front.png").string());
	const auto expected_top = buw::loadImage4b(dataPath("air-terminal-library-object_top.png").string());
	const auto expected_bottom = buw::loadImage4b(dataPath("air-terminal-library-object_bottom.png").string());
	const auto expected_left = buw::loadImage4b(dataPath("air-terminal-library-object_left.png").string());
	const auto expected_right = buw::loadImage4b(dataPath("air-terminal-library-object_right.png").string());
	const auto expected_back = buw::loadImage4b(dataPath("air-terminal-library-object_back.png").string());
...
TEST_F(AirTerminalLibraryObject, VertexViews)
{
	// Arrange
	const auto expected_front_left_bottom = buw::loadImage4b(dataPath("air-terminal-library-object_front_left_bottom.png").string());
	const auto expected_front_right_bottom = buw::loadImage4b(dataPath("air-terminal-library-object_front_right_bottom.png").string());
	const auto expected_top_left_front = buw::loadImage4b(dataPath("air-terminal-library-object_top_left_front.png").string());
	const auto expected_top_front_right = buw::loadImage4b(dataPath("air-terminal-library-object_top_front_right.png").string());
	const auto expected_top_left_back = buw::loadImage4b(dataPath("air-terminal-library-object_top_left_back.png").string());
	const auto expected_top_right_back = buw::loadImage4b(dataPath("air-terminal-library-object_top_right_back.png").string());
	const auto expected_back_left_bottom = buw::loadImage4b(dataPath("air-terminal-library-object_back_left_bottom.png").string());
	const auto expected_right_bottom_back = buw::loadImage4b(dataPath("air-terminal-library-object_right_bottom_back.png").string());
	...
	buw::storeImage(testPath("air-terminal-library-object_top_front_right.png").string(), image_top_front_right);
	buw::storeImage(testPath("air-terminal-library-object_top_left_back.png").string(), image_top_left_back);
