...
class BeamVaryingExtrusionPaths : public IfcVisualTest {
protected:
	...
	virtual std::string TestName() const { return "beam-varying-extrusion-paths"; }
	virtual std::string Schema() const { return "IFC4X1"; }

	const boost::filesystem::path filename = dataPath("beam-varying-extrusion-paths.ifc");
...
TEST_F(BeamVaryingExtrusionPaths, AllEntitiesAreRead) {
	EXPECT_THAT(express_model->entities.size(), Eq(67));
}
...
TEST_F(BeamVaryingExtrusionPaths, ImageIsSaved)
{
	...
	// Assert
	EXPECT_NO_THROW(buw::loadImage4b(testPath("beam-varying-extrusion-paths.png").string()));
}

TEST_F(BeamVaryingExtrusionPaths, PlaneSurfaceViews)
{
	// Arrange
	const auto expected_front = buw::loadImage4b(dataPath("beam-varying-extrusion-paths_front.png").string());
	const auto expected_top = buw::loadImage4b(dataPath("beam-varying-extrusion-paths_top.png").string());
	const auto expected_bottom = buw::loadImage4b(dataPath("beam-varying-extrusion-paths_bottom.png").string());
	const auto expected_left = buw::loadImage4b(dataPath("beam-varying-extrusion-paths_left.png").string());
	const auto expected_right = buw::loadImage4b(dataPath("beam-varying-extrusion-paths_right.png").string());
	const auto expected_back = buw::loadImage4b(dataPath("beam-varying-extrusion-paths_back.png").string());
...
TEST_F(BeamVaryingExtrusionPaths, VertexViews)
{
	// Arrange
	const auto expected_front_left_bottom = buw::loadImage4b(dataPath("beam-varying-extrusion-paths_front_left_bottom.png").string());
	const auto expected_front_right_bottom = buw::loadImage4b(dataPath("beam-varying-extrusion-paths_front_right_bottom.png").string());
	const auto expected_top_left_front = buw::loadImage4b(dataPath("beam-varying-extrusion-paths_top_left_front.png").string());
	const auto expected_top_front_right = buw::loadImage4b(dataPath("beam-varying-extrusion-paths_top_front_right.png").string());
	const auto expected_top_left_back = buw::loadImage4b(dataPath("beam-varying-extrusion-paths_top_left_back.png").string());
	const auto expected_top_right_back = buw::loadImage4b(dataPath("beam-varying-extrusion-paths_top_right_back.png").string());
	const auto expected_back_left_bottom = buw::loadImage4b(dataPath("beam-varying-extrusion-paths_back_left_bottom.png").string());
	const auto expected_right_bottom_back = buw::loadImage4b(dataPath("beam-varying-extrusion-paths_right_bottom_back.png").string());
	...
	buw::storeImage(testPath("beam-varying-extrusion-paths_top_front_right.png").string(), image_top_front_right);
	buw::storeImage(testPath("beam-varying-extrusion-paths_top_left_back.png").string(), image_top_left_back);
