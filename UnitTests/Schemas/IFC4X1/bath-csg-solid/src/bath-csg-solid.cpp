...
class BathCsgSolid : public IfcVisualTest {
protected:
	...
	virtual std::string TestName() const { return "bath-csg-solid"; }
	virtual std::string Schema() const { return "IFC4X1"; }

	const boost::filesystem::path filename = dataPath("bath-csg-solid.ifc");
...
TEST_F(BathCsgSolid, AllEntitiesAreRead) {
	EXPECT_THAT(express_model->entities.size(), Eq(47));
}

TEST_F(BathCsgSolid, IFCHasAnEssentialEntity) {
	...
	auto result3 = std::find_if(express_model->entities.begin(), express_model->entities.end(), [](auto &pair) -> bool { return pair.second->classname() == "IFCBLOCK"; });
	auto result4 = std::find_if(express_model->entities.begin(), express_model->entities.end(), [](auto &pair) -> bool { return pair.second->classname() == "IFCBOOLEANRESULT"; });
...
TEST_F(BathCsgSolid, ImageIsSaved)
{
	// Arrange
	buw::Image4b image = renderer->captureImage();

	// Act
	buw::storeImage(testPath("bath-csg-solid.png").string(), image);

	// Assert
	EXPECT_NO_THROW(buw::loadImage4b(testPath("bath-csg-solid.png").string()));
}

TEST_F(BathCsgSolid, PlaneSurfaceViews)
{
	// Arrange
	const auto expected_front = buw::loadImage4b(dataPath("bath-csg-solid_front.png").string());
	const auto expected_top = buw::loadImage4b(dataPath("bath-csg-solid_top.png").string());
	const auto expected_bottom = buw::loadImage4b(dataPath("bath-csg-solid_bottom.png").string());
	const auto expected_left = buw::loadImage4b(dataPath("bath-csg-solid_left.png").string());
	const auto expected_right = buw::loadImage4b(dataPath("bath-csg-solid_right.png").string());
	const auto expected_back = buw::loadImage4b(dataPath("bath-csg-solid_back.png").string());
	...
	/*
	buw::storeImage(testPath("bath-csg-solid_front.png").string(), image_front);
	buw::storeImage(testPath("bath-csg-solid_top.png").string(), image_top);
	buw::storeImage(testPath("bath-csg-solid_bottom.png").string(), image_bottom);
	buw::storeImage(testPath("bath-csg-solid_left.png").string(), image_left);
	buw::storeImage(testPath("bath-csg-solid_right.png").string(), image_right);
	buw::storeImage(testPath("bath-csg-solid_back.png").string(), image_back);
	*/
...
TEST_F(BathCsgSolid, VertexViews)
{
	// Arrange
	const auto expected_front_left_bottom = buw::loadImage4b(dataPath("bath-csg-solid_front_left_bottom.png").string());
	const auto expected_front_right_bottom = buw::loadImage4b(dataPath("bath-csg-solid_front_right_bottom.png").string());
	const auto expected_top_left_front = buw::loadImage4b(dataPath("bath-csg-solid_top_left_front.png").string());
	const auto expected_top_front_right = buw::loadImage4b(dataPath("bath-csg-solid_top_front_right.png").string());
	const auto expected_top_left_back = buw::loadImage4b(dataPath("bath-csg-solid_top_left_back.png").string());
	const auto expected_top_right_back = buw::loadImage4b(dataPath("bath-csg-solid_top_right_back.png").string());
	const auto expected_back_left_bottom = buw::loadImage4b(dataPath("bath-csg-solid_back_left_bottom.png").string());
	const auto expected_right_bottom_back = buw::loadImage4b(dataPath("bath-csg-solid_right_bottom_back.png").string());
	...
	// uncomment following lines to also save the screen shot
	/*
	buw::storeImage(testPath("bath-csg-solid_front_left_bottom.png").string(), image_front_left_bottom);
	buw::storeImage(testPath("bath-csg-solid_front_right_bottom.png").string(), image_front_right_bottom);
	buw::storeImage(testPath("bath-csg-solid_top_left_front.png").string(), image_top_left_front);
	buw::storeImage(testPath("bath-csg-solid_top_front_right.png").string(), image_top_front_right);
	buw::storeImage(testPath("bath-csg-solid_top_left_back.png").string(), image_top_left_back);
	buw::storeImage(testPath("bath-csg-solid_top_right_back.png").string(), image_top_right_back);
	buw::storeImage(testPath("bath-csg-solid_back_left_bottom.png").string(), image_back_left_bottom);
	buw::storeImage(testPath("bath-csg-solid_right_bottom_back.png").string(), image_right_bottom_back);
	*/
