...
class SlabOpenings : public IfcVisualTest {
protected:
...
TEST_F(SlabOpenings, ImageIsSaved)
{
	...
	// Act
	buw::storeImage(testPath("slab-openings.png").string(), image);

	// Assert
	EXPECT_NO_THROW(buw::loadImage4b(testPath("slab-openings.png").string()));
}

TEST_F(SlabOpenings, PlaneSurfaceViews)
{
	// Arrange
	const auto expected_front = buw::loadImage4b(dataPath("slab-openings_front.png").string());
	const auto expected_top = buw::loadImage4b(dataPath("slab-openings_top.png").string());
	const auto expected_bottom = buw::loadImage4b(dataPath("slab-openings_bottom.png").string());
	const auto expected_left = buw::loadImage4b(dataPath("slab-openings_left.png").string());
	const auto expected_right = buw::loadImage4b(dataPath("slab-openings_right.png").string());
	const auto expected_back = buw::loadImage4b(dataPath("slab-openings_back.png").string());
...
TEST_F(SlabOpenings, VertexViews)
{
	// Arrange
	const auto expected_front_left_bottom = buw::loadImage4b(dataPath("slab-openings_front_left_bottom.png").string());
	const auto expected_front_right_bottom = buw::loadImage4b(dataPath("slab-openings_front_right_bottom.png").string());
	const auto expected_top_left_front = buw::loadImage4b(dataPath("slab-openings_top_left_front.png").string());
	const auto expected_top_front_right = buw::loadImage4b(dataPath("slab-openings_top_front_right.png").string());
	const auto expected_top_left_back = buw::loadImage4b(dataPath("slab-openings_top_left_back.png").string());
	const auto expected_top_right_back = buw::loadImage4b(dataPath("slab-openings_top_right_back.png").string());
	const auto expected_back_left_bottom = buw::loadImage4b(dataPath("slab-openings_back_left_bottom.png").string());
	const auto expected_right_bottom_back = buw::loadImage4b(dataPath("slab-openings_right_bottom_back.png").string());
	...
	buw::storeImage(testPath("slab-openings_top_front_right.png").string(), image_top_front_right);
	buw::storeImage(testPath("slab-openings_top_left_back.png").string(), image_top_left_back);
