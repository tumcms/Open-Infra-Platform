...
class BeamRevolvedSolid : public IfcVisualTest {
protected:
	...
	virtual std::string TestName() const { return "beam-revolved-solid"; }
	virtual std::string Schema() const { return "IFC4X1"; }

	const boost::filesystem::path filename = dataPath("beam-revolved-solid.ifc");
...
TEST_F(BeamRevolvedSolid, IFCHasAnEssentialEntity) {
	auto result = std::find_if(express_model->entities.begin(), express_model->entities.end(), [](auto &pair) -> bool { return pair.second->classname() == "IFCREVOLVEDAREASOLID"; });
...
TEST_F(BeamRevolvedSolid, ImageIsSaved)
{
	...
	// Act
	buw::storeImage(testPath("beam-revolved-solid.png").string(), image);
...
TEST_F(BeamRevolvedSolid, PlaneSurfaceViews)
{
	...
	const auto expected_top = buw::loadImage4b(dataPath("beam-revolved-solid_top.png").string());
	const auto expected_bottom = buw::loadImage4b(dataPath("beam-revolved-solid_bottom.png").string());
	const auto expected_left = buw::loadImage4b(dataPath("beam-revolved-solid_left.png").string());
	const auto expected_right = buw::loadImage4b(dataPath("beam-revolved-solid_right.png").string());
	const auto expected_back = buw::loadImage4b(dataPath("beam-revolved-solid_back.png").string());
	...
	/*
	buw::storeImage(testPath("beam-revolved-solid_front.png").string(), image_front);
	buw::storeImage(testPath("beam-revolved-solid_top.png").string(), image_top);
	buw::storeImage(testPath("beam-revolved-solid_bottom.png").string(), image_bottom);
	buw::storeImage(testPath("beam-revolved-solid_left.png").string(), image_left);
	buw::storeImage(testPath("beam-revolved-solid_right.png").string(), image_right);
	buw::storeImage(testPath("beam-revolved-solid_back.png").string(), image_back);
	*/
...
TEST_F(BeamRevolvedSolid, VertexViews)
{
	...
	const auto expected_front_right_bottom = buw::loadImage4b(dataPath("beam-revolved-solid_front_right_bottom.png").string());
	const auto expected_top_left_front = buw::loadImage4b(dataPath("beam-revolved-solid_top_left_front.png").string());
	const auto expected_top_front_right = buw::loadImage4b(dataPath("beam-revolved-solid_top_front_right.png").string());
	const auto expected_top_left_back = buw::loadImage4b(dataPath("beam-revolved-solid_top_left_back.png").string());
	const auto expected_top_right_back = buw::loadImage4b(dataPath("beam-revolved-solid_top_right_back.png").string());
	const auto expected_back_left_bottom = buw::loadImage4b(dataPath("beam-revolved-solid_back_left_bottom.png").string());
	const auto expected_right_bottom_back = buw::loadImage4b(dataPath("beam-revolved-solid_right_bottom_back.png").string());
	...
	// uncomment following lines to also save the screen shot
	/*
	buw::storeImage(testPath("beam-revolved-solid_front_left_bottom.png").string(), image_front_left_bottom);
	buw::storeImage(testPath("beam-revolved-solid_front_right_bottom.png").string(), image_front_right_bottom);
	buw::storeImage(testPath("beam-revolved-solid_top_left_front.png").string(), image_top_left_front);
	buw::storeImage(testPath("beam-revolved-solid_top_front_right.png").string(), image_top_front_right);
	buw::storeImage(testPath("beam-revolved-solid_top_left_back.png").string(), image_top_left_back);
	buw::storeImage(testPath("beam-revolved-solid_top_right_back.png").string(), image_top_right_back);
	buw::storeImage(testPath("beam-revolved-solid_back_left_bottom.png").string(), image_back_left_bottom);
	buw::storeImage(testPath("beam-revolved-solid_right_bottom_back.png").string(), image_right_bottom_back);
	*/
