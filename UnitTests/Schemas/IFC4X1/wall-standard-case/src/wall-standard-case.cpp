...
class WallStandardCaseTest : public VisualTest {
    protected:
...
TEST_F(WallStandardCaseTest, AllEntitiesAreRead) {
    EXPECT_THAT(express_model->entities.size(), Eq(29));
}

TEST_F(WallStandardCaseTest, ImageIsSaved)
{
    // Arrange
...
TEST_F(WallStandardCaseTest, TopView)
{
    // Arrange
...
TEST_F(WallStandardCaseTest, BottomView)
{
    // Arrange
...
TEST_F(WallStandardCaseTest, LeftView)
{
    // Arrange
...
TEST_F(WallStandardCaseTest, RightView)
{
    // Arrange
...
TEST_F(WallStandardCaseTest, GivenNewImage_AfterHome_AreEqual)
{
    // Arrange
