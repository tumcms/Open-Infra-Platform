...
class PolygonalFaceTessellation : public IfcVisualTest {
protected:
	...
	virtual std::string TestName() const { return "polygonal-face-tessellation"; }
	virtual std::string Schema() const { return "IFC4X1"; }

	const boost::filesystem::path filename = dataPath("polygonal-face-tessellation.ifc");

	std::shared_ptr<oip::EXPRESSModel> express_model = nullptr;
	buw::ReferenceCounted<oip::IfcImporterT<emt::IFC4X1EntityTypes>> importer = nullptr;
};

TEST_F(PolygonalFaceTessellation, AllEntitiesAreRead) {
...
TEST_F(PolygonalFaceTessellation, ImageIsSaved)
{
	...
	// Act
	buw::storeImage(testPath("polygonal-face-tessellation.png").string(), image);

	// Assert
	EXPECT_NO_THROW(buw::loadImage4b(testPath("polygonal-face-tessellation.png").string()));
}

TEST_F(PolygonalFaceTessellation, PlaneSurfaceViews)
{
	// Arrange
	const auto expected_front = buw::loadImage4b(dataPath("polygonal-face-tessellation_front.png").string());
	const auto expected_top = buw::loadImage4b(dataPath("polygonal-face-tessellation_top.png").string());
	const auto expected_bottom = buw::loadImage4b(dataPath("polygonal-face-tessellation_bottom.png").string());
	const auto expected_left = buw::loadImage4b(dataPath("polygonal-face-tessellation_left.png").string());
	const auto expected_right = buw::loadImage4b(dataPath("polygonal-face-tessellation_right.png").string());
	const auto expected_back = buw::loadImage4b(dataPath("polygonal-face-tessellation_back.png").string());
...
TEST_F(PolygonalFaceTessellation, VertexViews)
{
	// Arrange
	const auto expected_front_left_bottom = buw::loadImage4b(dataPath("polygonal-face-tessellation_front_left_bottom.png").string());
	const auto expected_front_right_bottom = buw::loadImage4b(dataPath("polygonal-face-tessellation_front_right_bottom.png").string());
	const auto expected_top_left_front = buw::loadImage4b(dataPath("polygonal-face-tessellation_top_left_front.png").string());
	const auto expected_top_front_right = buw::loadImage4b(dataPath("polygonal-face-tessellation_top_front_right.png").string());
	const auto expected_top_left_back = buw::loadImage4b(dataPath("polygonal-face-tessellation_top_left_back.png").string());
	const auto expected_top_right_back = buw::loadImage4b(dataPath("polygonal-face-tessellation_top_right_back.png").string());
	const auto expected_back_left_bottom = buw::loadImage4b(dataPath("polygonal-face-tessellation_back_left_bottom.png").string());
	const auto expected_right_bottom_back = buw::loadImage4b(dataPath("polygonal-face-tessellation_right_bottom_back.png").string());
	...
	buw::storeImage(testPath("polygonal-face-tessellation_top_front_right.png").string(), image_top_front_right);
