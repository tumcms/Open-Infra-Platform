...
TEST_F(ConstructionSchedulingTask, ImageIsSaved)
{
	...
	// Act
	buw::storeImage(testPath("construction-scheduling-task.png").string(), image);
...
{
	// Arrange
	const auto expected_front = buw::loadImage4b(dataPath("construction-scheduling-task_front.png").string());
	const auto expected_top = buw::loadImage4b(dataPath("construction-scheduling-task_top.png").string());
	const auto expected_bottom = buw::loadImage4b(dataPath("construction-scheduling-task_bottom.png").string());
	const auto expected_left = buw::loadImage4b(dataPath("construction-scheduling-task_left.png").string());
	const auto expected_right = buw::loadImage4b(dataPath("construction-scheduling-task_right.png").string());
	const auto expected_back = buw::loadImage4b(dataPath("construction-scheduling-task_back.png").string());
...
TEST_F(ConstructionSchedulingTask, VertexViews)
{
	// Arrange
	const auto expected_front_left_bottom = buw::loadImage4b(dataPath("construction-scheduling-task_front_left_bottom.png").string());
	const auto expected_front_right_bottom = buw::loadImage4b(dataPath("construction-scheduling-task_front_right_bottom.png").string());
	const auto expected_top_left_front = buw::loadImage4b(dataPath("construction-scheduling-task_top_left_front.png").string());
	const auto expected_top_front_right = buw::loadImage4b(dataPath("construction-scheduling-task_top_front_right.png").string());
	const auto expected_top_left_back = buw::loadImage4b(dataPath("construction-scheduling-task_top_left_back.png").string());
	const auto expected_top_right_back = buw::loadImage4b(dataPath("construction-scheduling-task_top_right_back.png").string());
	const auto expected_back_left_bottom = buw::loadImage4b(dataPath("construction-scheduling-task_back_left_bottom.png").string());
	const auto expected_right_bottom_back = buw::loadImage4b(dataPath("construction-scheduling-task_right_bottom_back.png").string());
	...
	buw::storeImage(testPath("construction-scheduling-task_top_front_right.png").string(), image_top_front_right);
	buw::storeImage(testPath("construction-scheduling-task_top_left_back.png").string(), image_top_left_back);
