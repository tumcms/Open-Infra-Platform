...
class ReinforcingStirrup : public IfcVisualTest {
protected:
	...
	virtual std::string TestName() const { return "reinforcing-stirrup"; }
	virtual std::string Schema() const { return "IFC4x1"; }

	const boost::filesystem::path filename = dataPath("reinforcing-stirrup.ifc");
...
TEST_F(ReinforcingStirrup, AllEntitiesAreRead) {
	EXPECT_THAT(express_model->entities.size(), Eq(43));
}

TEST_F(ReinforcingStirrup, IFCHasAnEssentialEntity) {
...
TEST_F(ReinforcingStirrup, ImageIsSaved)
{
	// Arrange
	buw::Image4b image = renderer->captureImage();

	// Act
	buw::storeImage(testPath("reinforcing-stirrup.png").string(), image);

	// Assert
	EXPECT_NO_THROW(buw::loadImage4b(testPath("reinforcing-stirrup.png").string()));
}
/*
TEST_F(ReinforcingStirrup, PlaneSurfaceViews)
{
	// Arrange
	const auto expected_front = buw::loadImage4b(dataPath("reinforcing-stirrup_front.png").string());
	const auto expected_top = buw::loadImage4b(dataPath("reinforcing-stirrup_top.png").string());
	const auto expected_bottom = buw::loadImage4b(dataPath("reinforcing-stirrup_bottom.png").string());
	const auto expected_left = buw::loadImage4b(dataPath("reinforcing-stirrup_left.png").string());
	const auto expected_right = buw::loadImage4b(dataPath("reinforcing-stirrup_right.png").string());
	const auto expected_back = buw::loadImage4b(dataPath("reinforcing-stirrup_back.png").string());
	...
	buw::storeImage(testPath("reinforcing-stirrup_front.png").string(), image_front);
	buw::storeImage(testPath("reinforcing-stirrup_top.png").string(), image_top);
	buw::storeImage(testPath("reinforcing-stirrup_bottom.png").string(), image_bottom);
	buw::storeImage(testPath("reinforcing-stirrup_left.png").string(), image_left);
	buw::storeImage(testPath("reinforcing-stirrup_right.png").string(), image_right);
	buw::storeImage(testPath("reinforcing-stirrup_back.png").string(), image_back);
...
TEST_F(ReinforcingStirrup, VertexViews)
{
	// Arrange
	const auto expected_front_left_bottom = buw::loadImage4b(dataPath("reinforcing-stirrup_front_left_bottom.png").string());
	const auto expected_front_right_bottom = buw::loadImage4b(dataPath("reinforcing-stirrup_front_right_bottom.png").string());
	const auto expected_top_left_front = buw::loadImage4b(dataPath("reinforcing-stirrup_top_left_front.png").string());
	const auto expected_top_front_right = buw::loadImage4b(dataPath("reinforcing-stirrup_top_front_right.png").string());
	const auto expected_top_left_back = buw::loadImage4b(dataPath("reinforcing-stirrup_top_left_back.png").string());
	const auto expected_top_right_back = buw::loadImage4b(dataPath("reinforcing-stirrup_top_right_back.png").string());
	const auto expected_back_left_bottom = buw::loadImage4b(dataPath("reinforcing-stirrup_back_left_bottom.png").string());
	const auto expected_right_bottom_back = buw::loadImage4b(dataPath("reinforcing-stirrup_right_bottom_back.png").string());
	...
	buw::storeImage(testPath("reinforcing-stirrup_front_left_bottom.png").string(), image_front_left_bottom);
	buw::storeImage(testPath("reinforcing-stirrup_front_right_bottom.png").string(), image_front_right_bottom);
	buw::storeImage(testPath("reinforcing-stirrup_top_left_front.png").string(), image_top_left_front);
	buw::storeImage(testPath("reinforcing-stirrup_top_front_right.png").string(), image_top_front_right);
	buw::storeImage(testPath("reinforcing-stirrup_top_left_back.png").string(), image_top_left_back);
	buw::storeImage(testPath("reinforcing-stirrup_top_right_back.png").string(), image_top_right_back);
	buw::storeImage(testPath("reinforcing-stirrup_back_left_bottom.png").string(), image_back_left_bottom);
	buw::storeImage(testPath("reinforcing-stirrup_right_bottom_back.png").string(), image_right_bottom_back);
