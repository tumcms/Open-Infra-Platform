...
class TerrainSurface : public IfcVisualTest {
protected:
...
TEST_F(TerrainSurface, ImageIsSaved)
{
	...
	// Act
	buw::storeImage(testPath("terrain-surface.png").string(), image);

	// Assert
	EXPECT_NO_THROW(buw::loadImage4b(testPath("terrain-surface.png").string()));
}

TEST_F(TerrainSurface, PlaneSurfaceViews)
{
	// Arrange
	const auto expected_front = buw::loadImage4b(dataPath("terrain-surface_front.png").string());
	const auto expected_top = buw::loadImage4b(dataPath("terrain-surface_top.png").string());
	const auto expected_bottom = buw::loadImage4b(dataPath("terrain-surface_bottom.png").string());
	const auto expected_left = buw::loadImage4b(dataPath("terrain-surface_left.png").string());
	const auto expected_right = buw::loadImage4b(dataPath("terrain-surface_right.png").string());
	const auto expected_back = buw::loadImage4b(dataPath("terrain-surface_back.png").string());
	...
	/*
	buw::storeImage(testPath("terrain-surface_front.png").string(), image_front);
	buw::storeImage(testPath("terrain-surface_top.png").string(), image_top);
	buw::storeImage(testPath("terrain-surface_bottom.png").string(), image_bottom);
	buw::storeImage(testPath("terrain-surface_left.png").string(), image_left);
	buw::storeImage(testPath("terrain-surface_right.png").string(), image_right);
	buw::storeImage(testPath("terrain-surface_back.png").string(), image_back);
	*/
...
TEST_F(TerrainSurface, VertexViews)
{
	// Arrange
	const auto expected_front_left_bottom = buw::loadImage4b(dataPath("terrain-surface_front_left_bottom.png").string());
	const auto expected_front_right_bottom = buw::loadImage4b(dataPath("terrain-surface_front_right_bottom.png").string());
	const auto expected_top_left_front = buw::loadImage4b(dataPath("terrain-surface_top_left_front.png").string());
	const auto expected_top_front_right = buw::loadImage4b(dataPath("terrain-surface_top_front_right.png").string());
	const auto expected_top_left_back = buw::loadImage4b(dataPath("terrain-surface_top_left_back.png").string());
	const auto expected_top_right_back = buw::loadImage4b(dataPath("terrain-surface_top_right_back.png").string());
	const auto expected_back_left_bottom = buw::loadImage4b(dataPath("terrain-surface_back_left_bottom.png").string());
	const auto expected_right_bottom_back = buw::loadImage4b(dataPath("terrain-surface_right_bottom_back.png").string());
	...
	// uncomment following lines to also save the screen shot
	/*
	buw::storeImage(testPath("terrain-surface_front_left_bottom.png").string(), image_front_left_bottom);
	buw::storeImage(testPath("terrain-surface_front_right_bottom.png").string(), image_front_right_bottom);
	buw::storeImage(testPath("terrain-surface_top_left_front.png").string(), image_top_left_front);
	buw::storeImage(testPath("terrain-surface_top_front_right.png").string(), image_top_front_right);
	buw::storeImage(testPath("terrain-surface_top_left_back.png").string(), image_top_left_back);
	buw::storeImage(testPath("terrain-surface_top_right_back.png").string(), image_top_right_back);
	buw::storeImage(testPath("terrain-surface_back_left_bottom.png").string(), image_back_left_bottom);
	buw::storeImage(testPath("terrain-surface_right_bottom_back.png").string(), image_right_bottom_back);
	*/
