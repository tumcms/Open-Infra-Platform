...
class Octahedron : public OffVisualTest 
{
protected:
	...
	virtual std::string TestName() const { return "octahedron"; }

	const boost::filesystem::path filename = dataPath("octahedron.off");

	buw::ReferenceCounted<oip::OffModel> model = buw::makeReferenceCounted<oip::OffModel>();
};

TEST_F(Octahedron, AllEdgesAndFacesRed)
{
...
TEST_F(Octahedron, ImageIsSaved)
{
	...
	// Act
    buw::storeImage(testPath("octahedron.png").string(), image);

	// Assert
    EXPECT_NO_THROW(buw::loadImage4b(testPath("octahedron.png").string()));
}

TEST_F(Octahedron, PlaneSurfaceViews)
{
	// Arrange
    const auto expected_front = buw::loadImage4b(dataPath("octahedron_front.png").string());
    const auto expected_top = buw::loadImage4b(dataPath("octahedron_top.png").string());
    const auto expected_bottom = buw::loadImage4b(dataPath("octahedron_bottom.png").string());
    const auto expected_left = buw::loadImage4b(dataPath("octahedron_left.png").string());
    const auto expected_right = buw::loadImage4b(dataPath("octahedron_right.png").string());
    const auto expected_back = buw::loadImage4b(dataPath("octahedron_back.png").string());
...
TEST_F(Octahedron, VertexViews)
{
	// Arrange
    const auto expected_front_left_bottom = buw::loadImage4b(dataPath("octahedron_front_left_bottom.png").string());
    const auto expected_front_right_bottom = buw::loadImage4b(dataPath("octahedron_front_right_bottom.png").string());
    const auto expected_top_left_front = buw::loadImage4b(dataPath("octahedron_top_left_front.png").string());
    const auto expected_top_front_right = buw::loadImage4b(dataPath("octahedron_top_front_right.png").string());
    const auto expected_top_left_back = buw::loadImage4b(dataPath("octahedron_top_left_back.png").string());
    const auto expected_top_right_back = buw::loadImage4b(dataPath("octahedron_top_right_back.png").string());
    const auto expected_back_left_bottom = buw::loadImage4b(dataPath("octahedron_back_left_bottom.png").string());
    const auto expected_right_bottom_back = buw::loadImage4b(dataPath("octahedron_right_bottom_back.png").string());
