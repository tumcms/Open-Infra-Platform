...
class Octtorus : public OffVisualTest 
{
protected:
	...
	virtual std::string TestName() const { return "octtorus"; }

	const boost::filesystem::path filename = dataPath("octtorus.off");

	buw::ReferenceCounted<oip::OffModel> model = buw::makeReferenceCounted<oip::OffModel>();
};

TEST_F(Octtorus, AllEdgesAndFacesRed)
{
...
TEST_F(Octtorus, ImageIsSaved)
{
	...
	// Act
    buw::storeImage(testPath("octtorus.png").string(), image);

	// Assert
    EXPECT_NO_THROW(buw::loadImage4b(testPath("octtorus.png").string()));
}

TEST_F(Octtorus, PlaneSurfaceViews)
{
	// Arrange
    const auto expected_front = buw::loadImage4b(dataPath("octtorus_front.png").string());
    const auto expected_top = buw::loadImage4b(dataPath("octtorus_top.png").string());
    const auto expected_bottom = buw::loadImage4b(dataPath("octtorus_bottom.png").string());
    const auto expected_left = buw::loadImage4b(dataPath("octtorus_left.png").string());
    const auto expected_right = buw::loadImage4b(dataPath("octtorus_right.png").string());
    const auto expected_back = buw::loadImage4b(dataPath("octtorus_back.png").string());
...
TEST_F(Octtorus, VertexViews)
{
	// Arrange
    const auto expected_front_left_bottom = buw::loadImage4b(dataPath("octtorus_front_left_bottom.png").string());
    const auto expected_front_right_bottom = buw::loadImage4b(dataPath("octtorus_front_right_bottom.png").string());
    const auto expected_top_left_front = buw::loadImage4b(dataPath("octtorus_top_left_front.png").string());
    const auto expected_top_front_right = buw::loadImage4b(dataPath("octtorus_top_front_right.png").string());
    const auto expected_top_left_back = buw::loadImage4b(dataPath("octtorus_top_left_back.png").string());
    const auto expected_top_right_back = buw::loadImage4b(dataPath("octtorus_top_right_back.png").string());
    const auto expected_back_left_bottom = buw::loadImage4b(dataPath("octtorus_back_left_bottom.png").string());
    const auto expected_right_bottom_back = buw::loadImage4b(dataPath("octtorus_right_bottom_back.png").string());
