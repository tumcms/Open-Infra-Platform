...
class Snub_cube : public OffVisualTest 
{
protected:
	...
	virtual std::string TestName() const { return "snub_cube"; }

	const boost::filesystem::path filename = dataPath("snub_cube.off");

	buw::ReferenceCounted<oip::OffModel> model = buw::makeReferenceCounted<oip::OffModel>();
};

TEST_F(Snub_cube, AllEdgesAndFacesRed)
{
...
TEST_F(Snub_cube, ImageIsSaved)
{
	...
	// Act
    buw::storeImage(testPath("snub_cube.png").string(), image);

	// Assert
    EXPECT_NO_THROW(buw::loadImage4b(testPath("snub_cube.png").string()));
}

TEST_F(Snub_cube, PlaneSurfaceViews)
{
	// Arrange
    const auto expected_front = buw::loadImage4b(dataPath("snub_cube_front.png").string());
    const auto expected_top = buw::loadImage4b(dataPath("snub_cube_top.png").string());
    const auto expected_bottom = buw::loadImage4b(dataPath("snub_cube_bottom.png").string());
    const auto expected_left = buw::loadImage4b(dataPath("snub_cube_left.png").string());
    const auto expected_right = buw::loadImage4b(dataPath("snub_cube_right.png").string());
    const auto expected_back = buw::loadImage4b(dataPath("snub_cube_back.png").string());
...
TEST_F(Snub_cube, VertexViews)
{
	// Arrange
    const auto expected_front_left_bottom = buw::loadImage4b(dataPath("snub_cube_front_left_bottom.png").string());
    const auto expected_front_right_bottom = buw::loadImage4b(dataPath("snub_cube_front_right_bottom.png").string());
    const auto expected_top_left_front = buw::loadImage4b(dataPath("snub_cube_top_left_front.png").string());
    const auto expected_top_front_right = buw::loadImage4b(dataPath("snub_cube_top_front_right.png").string());
    const auto expected_top_left_back = buw::loadImage4b(dataPath("snub_cube_top_left_back.png").string());
    const auto expected_top_right_back = buw::loadImage4b(dataPath("snub_cube_top_right_back.png").string());
    const auto expected_back_left_bottom = buw::loadImage4b(dataPath("snub_cube_back_left_bottom.png").string());
    const auto expected_right_bottom_back = buw::loadImage4b(dataPath("snub_cube_right_bottom_back.png").string());
