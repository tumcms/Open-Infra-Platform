...
class Goblet : public OffVisualTest 
{
protected:
	...
	virtual std::string TestName() const { return "goblet"; }

	const boost::filesystem::path filename = dataPath("goblet.off");

	buw::ReferenceCounted<oip::OffModel> model = buw::makeReferenceCounted<oip::OffModel>();
};

TEST_F(Goblet, AllEdgesAndFacesRed)
{
...
TEST_F(Goblet, ImageIsSaved)
{
	// Arrange
	buw::Image4b image = rendererOff->captureImage();

	// Act
    buw::storeImage(testPath("goblet.png").string(), image);

	// Assert
    EXPECT_NO_THROW(buw::loadImage4b(testPath("goblet.png").string()));
}

TEST_F(Goblet, PlaneSurfaceViews)
{
	// Arrange
    const auto expected_front = buw::loadImage4b(dataPath("goblet_front.png").string());
    const auto expected_top = buw::loadImage4b(dataPath("goblet_top.png").string());
    const auto expected_bottom = buw::loadImage4b(dataPath("goblet_bottom.png").string());
    const auto expected_left = buw::loadImage4b(dataPath("goblet_left.png").string());
    const auto expected_right = buw::loadImage4b(dataPath("goblet_right.png").string());
    const auto expected_back = buw::loadImage4b(dataPath("goblet_back.png").string());
...
TEST_F(Goblet, VertexViews)
{
	// Arrange
    const auto expected_front_left_bottom = buw::loadImage4b(dataPath("goblet_front_left_bottom.png").string());
    const auto expected_front_right_bottom = buw::loadImage4b(dataPath("goblet_front_right_bottom.png").string());
    const auto expected_top_left_front = buw::loadImage4b(dataPath("goblet_top_left_front.png").string());
    const auto expected_top_front_right = buw::loadImage4b(dataPath("goblet_top_front_right.png").string());
    const auto expected_top_left_back = buw::loadImage4b(dataPath("goblet_top_left_back.png").string());
    const auto expected_top_right_back = buw::loadImage4b(dataPath("goblet_top_right_back.png").string());
    const auto expected_back_left_bottom = buw::loadImage4b(dataPath("goblet_back_left_bottom.png").string());
    const auto expected_right_bottom_back = buw::loadImage4b(dataPath("goblet_right_bottom_back.png").string());
    ...
    //buw::storeImage(testPath("goblet_front_left_bottom.png").string(), image_front_left_bottom);
    //buw::storeImage(testPath("goblet_front_right_bottom.png").string(), image_front_right_bottom);
    //buw::storeImage(testPath("goblet_top_left_front.png").string(), image_top_left_front);
    //buw::storeImage(testPath("goblet_top_front_right.png").string(), image_top_front_right);
    //buw::storeImage(testPath("goblet_top_left_back.png").string(), image_top_left_back);
    //buw::storeImage(testPath("goblet_top_right_back.png").string(), image_top_right_back);
    //buw::storeImage(testPath("goblet_back_left_bottom.png").string(), image_back_left_bottom);
    //buw::storeImage(testPath("goblet_right_bottom_back.png").string(), image_right_bottom_back);
