...
class Cone : public OffVisualTest 
{
protected:
	...
	virtual std::string TestName() const { return "cone"; }

	const boost::filesystem::path filename = dataPath("cone.off");

	buw::ReferenceCounted<oip::OffModel> model = buw::makeReferenceCounted<oip::OffModel>();
};

TEST_F(Cone, AllEdgesAndFacesRed)
{
	...
	EXPECT_THAT(model->geometry().vertices.size(), Eq(120));
	// check for the number of indices (see comment for vertices)
	EXPECT_THAT(model->geometry().indices.size(), Eq(120));
}

TEST_F(Cone, ImageIsSaved)
{
	// Arrange
	buw::Image4b image = rendererOff->captureImage();

	// Act
    buw::storeImage(testPath("cone.png").string(), image);

	// Assert
    EXPECT_NO_THROW(buw::loadImage4b(testPath("cone.png").string()));
}

TEST_F(Cone, PlaneSurfaceViews)
{
	// Arrange
    const auto expected_front = buw::loadImage4b(dataPath("cone_front.png").string());
    const auto expected_top = buw::loadImage4b(dataPath("cone_top.png").string());
    const auto expected_bottom = buw::loadImage4b(dataPath("cone_bottom.png").string());
    const auto expected_left = buw::loadImage4b(dataPath("cone_left.png").string());
    const auto expected_right = buw::loadImage4b(dataPath("cone_right.png").string());
    const auto expected_back = buw::loadImage4b(dataPath("cone_back.png").string());
    ...
    //buw::storeImage(testPath("cone_front.png").string(), image_front);
    //buw::storeImage(testPath("cone_top.png").string(), image_top);
    //buw::storeImage(testPath("cone_bottom.png").string(), image_bottom);
    //buw::storeImage(testPath("cone_left.png").string(), image_left);
    //buw::storeImage(testPath("cone_right.png").string(), image_right);
    //buw::storeImage(testPath("cone_back.png").string(), image_back);
...
TEST_F(Cone, VertexViews)
{
	// Arrange
    const auto expected_front_left_bottom = buw::loadImage4b(dataPath("cone_front_left_bottom.png").string());
    const auto expected_front_right_bottom = buw::loadImage4b(dataPath("cone_front_right_bottom.png").string());
    const auto expected_top_left_front = buw::loadImage4b(dataPath("cone_top_left_front.png").string());
    const auto expected_top_front_right = buw::loadImage4b(dataPath("cone_top_front_right.png").string());
    const auto expected_top_left_back = buw::loadImage4b(dataPath("cone_top_left_back.png").string());
    const auto expected_top_right_back = buw::loadImage4b(dataPath("cone_top_right_back.png").string());
    const auto expected_back_left_bottom = buw::loadImage4b(dataPath("cone_back_left_bottom.png").string());
    const auto expected_right_bottom_back = buw::loadImage4b(dataPath("cone_right_bottom_back.png").string());
    ...
    //buw::storeImage(testPath("cone_front_left_bottom.png").string(), image_front_left_bottom);
    //buw::storeImage(testPath("cone_front_right_bottom.png").string(), image_front_right_bottom);
    //buw::storeImage(testPath("cone_top_left_front.png").string(), image_top_left_front);
    //buw::storeImage(testPath("cone_top_front_right.png").string(), image_top_front_right);
    //buw::storeImage(testPath("cone_top_left_back.png").string(), image_top_left_back);
    //buw::storeImage(testPath("cone_top_right_back.png").string(), image_top_right_back);
    //buw::storeImage(testPath("cone_back_left_bottom.png").string(), image_back_left_bottom);
    //buw::storeImage(testPath("cone_right_bottom_back.png").string(), image_right_bottom_back);
