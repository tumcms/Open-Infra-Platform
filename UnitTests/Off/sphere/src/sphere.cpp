...
class Sphere : public OffVisualTest 
{
protected:
	...
	virtual std::string TestName() const { return "sphere"; }

	const boost::filesystem::path filename = dataPath("sphere.off");

	buw::ReferenceCounted<oip::OffModel> model = buw::makeReferenceCounted<oip::OffModel>();
};

TEST_F(Sphere, AllEdgesAndFacesRed)
{
...
TEST_F(Sphere, ImageIsSaved)
{
	...
	// Act
    buw::storeImage(testPath("sphere.png").string(), image);

	// Assert
    EXPECT_NO_THROW(buw::loadImage4b(testPath("sphere.png").string()));
}

TEST_F(Sphere, PlaneSurfaceViews)
{
	// Arrange
    const auto expected_front = buw::loadImage4b(dataPath("sphere_front.png").string());
    const auto expected_top = buw::loadImage4b(dataPath("sphere_top.png").string());
    const auto expected_bottom = buw::loadImage4b(dataPath("sphere_bottom.png").string());
    const auto expected_left = buw::loadImage4b(dataPath("sphere_left.png").string());
    const auto expected_right = buw::loadImage4b(dataPath("sphere_right.png").string());
    const auto expected_back = buw::loadImage4b(dataPath("sphere_back.png").string());
    ...
    buw::storeImage(testPath("sphere_front.png").string(), image_front);
    buw::storeImage(testPath("sphere_top.png").string(), image_top);
    buw::storeImage(testPath("sphere_bottom.png").string(), image_bottom);
    buw::storeImage(testPath("sphere_left.png").string(), image_left);
    buw::storeImage(testPath("sphere_right.png").string(), image_right);
    buw::storeImage(testPath("sphere_back.png").string(), image_back);
...
TEST_F(Sphere, VertexViews)
{
	// Arrange
    const auto expected_front_left_bottom = buw::loadImage4b(dataPath("sphere_front_left_bottom.png").string());
    const auto expected_front_right_bottom = buw::loadImage4b(dataPath("sphere_front_right_bottom.png").string());
    const auto expected_top_left_front = buw::loadImage4b(dataPath("sphere_top_left_front.png").string());
    const auto expected_top_front_right = buw::loadImage4b(dataPath("sphere_top_front_right.png").string());
    const auto expected_top_left_back = buw::loadImage4b(dataPath("sphere_top_left_back.png").string());
    const auto expected_top_right_back = buw::loadImage4b(dataPath("sphere_top_right_back.png").string());
    const auto expected_back_left_bottom = buw::loadImage4b(dataPath("sphere_back_left_bottom.png").string());
    const auto expected_right_bottom_back = buw::loadImage4b(dataPath("sphere_right_bottom_back.png").string());
