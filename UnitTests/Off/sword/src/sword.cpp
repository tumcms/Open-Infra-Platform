...
class Sword : public OffVisualTest 
{
protected:
	...
	virtual std::string TestName() const { return "sword"; }

	const boost::filesystem::path filename = dataPath("sword.off");

	buw::ReferenceCounted<oip::OffModel> model = buw::makeReferenceCounted<oip::OffModel>();
};

TEST_F(Sword, AllEdgesAndFacesRed)
{
	...
	EXPECT_THAT(model->geometry().vertices.size(), Eq(3108));
	// check for the number of indices (see comment for vertices)
	EXPECT_THAT(model->geometry().indices.size(), Eq(3108));
}

TEST_F(Sword, ImageIsSaved)
{
	// Arrange
	buw::Image4b image = rendererOff->captureImage();

	// Act
    buw::storeImage(testPath("sword.png").string(), image);

	// Assert
    EXPECT_NO_THROW(buw::loadImage4b(testPath("sword.png").string()));
}

TEST_F(Sword, PlaneSurfaceViews)
{
	// Arrange
    const auto expected_front = buw::loadImage4b(dataPath("sword_front.png").string());
    const auto expected_top = buw::loadImage4b(dataPath("sword_top.png").string());
    const auto expected_bottom = buw::loadImage4b(dataPath("sword_bottom.png").string());
    const auto expected_left = buw::loadImage4b(dataPath("sword_left.png").string());
    const auto expected_right = buw::loadImage4b(dataPath("sword_right.png").string());
    const auto expected_back = buw::loadImage4b(dataPath("sword_back.png").string());
    ...
    //buw::storeImage(testPath("sword_front.png").string(), image_front);
    //buw::storeImage(testPath("sword_top.png").string(), image_top);
    //buw::storeImage(testPath("sword_bottom.png").string(), image_bottom);
    //buw::storeImage(testPath("sword_left.png").string(), image_left);
    //buw::storeImage(testPath("sword_right.png").string(), image_right);
    //buw::storeImage(testPath("sword_back.png").string(), image_back);
...
TEST_F(Sword, VertexViews)
{
	// Arrange
    const auto expected_front_left_bottom = buw::loadImage4b(dataPath("sword_front_left_bottom.png").string());
    const auto expected_front_right_bottom = buw::loadImage4b(dataPath("sword_front_right_bottom.png").string());
    const auto expected_top_left_front = buw::loadImage4b(dataPath("sword_top_left_front.png").string());
    const auto expected_top_front_right = buw::loadImage4b(dataPath("sword_top_front_right.png").string());
    const auto expected_top_left_back = buw::loadImage4b(dataPath("sword_top_left_back.png").string());
    const auto expected_top_right_back = buw::loadImage4b(dataPath("sword_top_right_back.png").string());
    const auto expected_back_left_bottom = buw::loadImage4b(dataPath("sword_back_left_bottom.png").string());
    const auto expected_right_bottom_back = buw::loadImage4b(dataPath("sword_right_bottom_back.png").string());
    ...
    //buw::storeImage(testPath("sword_front_left_bottom.png").string(), image_front_left_bottom);
    //buw::storeImage(testPath("sword_front_right_bottom.png").string(), image_front_right_bottom);
    //buw::storeImage(testPath("sword_top_left_front.png").string(), image_top_left_front);
    //buw::storeImage(testPath("sword_top_front_right.png").string(), image_top_front_right);
    //buw::storeImage(testPath("sword_top_left_back.png").string(), image_top_left_back);
    //buw::storeImage(testPath("sword_top_right_back.png").string(), image_top_right_back);
    //buw::storeImage(testPath("sword_back_left_bottom.png").string(), image_back_left_bottom);
    //buw::storeImage(testPath("sword_right_bottom_back.png").string(), image_right_bottom_back);
