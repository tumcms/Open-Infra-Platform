...
class Boxtorus : public OffVisualTest
{
protected:
	...
	virtual std::string TestName() const { return "boxtorus"; }

	const boost::filesystem::path filename = dataPath("boxtorus.off");

	buw::ReferenceCounted<oip::OffModel> model = buw::makeReferenceCounted<oip::OffModel>();
};

TEST_F(Boxtorus, AllEdgesAndFacesRed)
{
...
TEST_F(Boxtorus, ImageIsSaved)
{
	// Arrange
	buw::Image4b image = rendererOff->captureImage();

	// Act
    buw::storeImage(testPath("boxtorus.png").string(), image);

	// Assert
    EXPECT_NO_THROW(buw::loadImage4b(testPath("boxtorus.png").string()));
}

TEST_F(Boxtorus, PlaneSurfaceViews)
{
	// Arrange
    const auto expected_front = buw::loadImage4b(dataPath("boxtorus_front.png").string());
    const auto expected_top = buw::loadImage4b(dataPath("boxtorus_top.png").string());
    const auto expected_bottom = buw::loadImage4b(dataPath("boxtorus_bottom.png").string());
    const auto expected_left = buw::loadImage4b(dataPath("boxtorus_left.png").string());
    const auto expected_right = buw::loadImage4b(dataPath("boxtorus_right.png").string());
    const auto expected_back = buw::loadImage4b(dataPath("boxtorus_back.png").string());
	...
	/*
    buw::storeImage(testPath("boxtorus_front.png").string(), image_front);
    buw::storeImage(testPath("boxtorus_top.png").string(), image_top);
    buw::storeImage(testPath("boxtorus_bottom.png").string(), image_bottom);
    buw::storeImage(testPath("boxtorus_left.png").string(), image_left);
    buw::storeImage(testPath("boxtorus_right.png").string(), image_right);
    buw::storeImage(testPath("boxtorus_back.png").string(), image_back);
	*/
...
TEST_F(Boxtorus, VertexViews)
{
	// Arrange
    const auto expected_front_left_bottom = buw::loadImage4b(dataPath("boxtorus_front_left_bottom.png").string());
    const auto expected_front_right_bottom = buw::loadImage4b(dataPath("boxtorus_front_right_bottom.png").string());
    const auto expected_top_left_front = buw::loadImage4b(dataPath("boxtorus_top_left_front.png").string());
    const auto expected_top_front_right = buw::loadImage4b(dataPath("boxtorus_top_front_right.png").string());
    const auto expected_top_left_back = buw::loadImage4b(dataPath("boxtorus_top_left_back.png").string());
    const auto expected_top_right_back = buw::loadImage4b(dataPath("boxtorus_top_right_back.png").string());
    const auto expected_back_left_bottom = buw::loadImage4b(dataPath("boxtorus_back_left_bottom.png").string());
    const auto expected_right_bottom_back = buw::loadImage4b(dataPath("boxtorus_right_bottom_back.png").string());
	...
	// uncomment following lines to also save the screen shot
	/*
    buw::storeImage(testPath("boxtorus_front_left_bottom.png").string(), image_front_left_bottom);
    buw::storeImage(testPath("boxtorus_front_right_bottom.png").string(), image_front_right_bottom);
    buw::storeImage(testPath("boxtorus_top_left_front.png").string(), image_top_left_front);
    buw::storeImage(testPath("boxtorus_top_front_right.png").string(), image_top_front_right);
    buw::storeImage(testPath("boxtorus_top_left_back.png").string(), image_top_left_back);
    buw::storeImage(testPath("boxtorus_top_right_back.png").string(), image_top_right_back);
    buw::storeImage(testPath("boxtorus_back_left_bottom.png").string(), image_back_left_bottom);
    buw::storeImage(testPath("boxtorus_right_bottom_back.png").string(), image_right_bottom_back);
	*/
