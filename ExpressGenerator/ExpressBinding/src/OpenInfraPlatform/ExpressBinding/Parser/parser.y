...
%{
	...
	#include "OpenInfraPlatform/ExpressBinding/stack.h"
...
%union {
	OpenInfraPlatform::ExpressBinding::Node*                node;
	OpenInfraPlatform::ExpressBinding::SchemaDecl*			schema_decl;
	OpenInfraPlatform::ExpressBinding::RuleLabelIdentifier* rule_label_id;
	OpenInfraPlatform::ExpressBinding::DomainRule*          domain_rule;
	OpenInfraPlatform::ExpressBinding::DomainRules*         domain_rules;
	OpenInfraPlatform::ExpressBinding::WhereClause*			where_clause;
	OpenInfraPlatform::ExpressBinding::Expression*			expression;
