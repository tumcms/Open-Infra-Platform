			...
			public:
				...
				*/
				...
				) const throw(...)
				{
					...
					{
						return convertIfcSegmentedReferenceCurve(boundedCurve.as<typename IfcEntityTypesT::IfcSegmentedReferenceCurve>(),
							targetVec, segmentStartPoints);
				...
				* \param[out] segmentStartPoints			The starting points of separate segments.
				*/
				void convertIfcSegmentedReferenceCurve(const EXPRESSReference<typename IfcEntityTypesT::IfcSegmentedReferenceCurve>& segmentedReferenceCurve,
					std::vector<carve::geom::vector<3>>& targetVec,
					std::vector<carve::geom::vector<3>>& segmentStartPoints
				) const throw(...)
				{
