					...
					bool senseAgreement) const
				{
					...
					*/
					...
					if (bounded_curve)
					{
						...
						std::shared_ptr<IFC4X3::IfcAlignmentCurve> alignment_curve =
							std::dynamic_pointer_cast<IFC4X3::IfcAlignmentCurve>(bounded_curve);
						if (alignment_curve) {
							...
							public:
								...
								std::shared_ptr<IFC4X3::IfcAlignment2DHorizontalSegment> itHorizontal_;	// pointer to specific horizontal segment.

								HorizontalSegment(double startX, double startY, double startDirection, double segmentLength, std::shared_ptr<IFC4X3::IfcAlignment2DHorizontalSegment> itHorizontal,// members of HorizontalSegment
							...
							public:
								...
								std::shared_ptr<IFC4X3::IfcAlignment2DVerticalSegment> itVertical_;	// pointer to specific vertical segment.

								VerticalSegment(double startZ, double startDistAlong, double horizontalLength, double startGradient, std::shared_ptr<IFC4X3::IfcAlignment2DVerticalSegment> itVertical, // members of VerticalSegment
									std::vector<Station> segmentStations, segmentType segType, int fragmentsCount, double fragmentsLength) // members of Segment
									: Segment(segmentStations, segType, fragmentsCount, fragmentsLength),
							...
							std::shared_ptr<IFC4X3::IfcAlignment2DHorizontal> horizontal = alignment_curve->Horizontal.lock();
							...
							std::vector<std::shared_ptr<IFC4X3::IfcAlignment2DHorizontalSegment> > horSegments;
							...
							for (auto it_segment : horSegments) {
								...
								std::shared_ptr<IFC4X3::IfcCurveSegment2D> horCurveGeometry =
							...
							// http://www.buildingsmart-tech.org/ifc/IFC4x1/final/html/schema/ifcgeometryresource/lexical/ifccurvesegment2d.htm
								std::shared_ptr<IFC4X3::IfcLineSegment2D> line_segment_2D =
									std::dynamic_pointer_cast<IFC4X3::IfcLineSegment2D>(horCurveGeometry);
								std::shared_ptr<IFC4X3::IfcCircularArcSegment2D> circular_arc_segment_2D =
									std::dynamic_pointer_cast<IFC4X3::IfcCircularArcSegment2D>(horCurveGeometry);
								std::shared_ptr<IFC4X3::IfcTransitionCurveSegment2D> trans_curve_segment_2D =
									std::dynamic_pointer_cast<IFC4X3::IfcTransitionCurveSegment2D>(horCurveGeometry);
							...
							else
							{
								...
								std::vector<std::shared_ptr<IFC4X3::IfcAlignment2DVerticalSegment> > verSegments;
								...
								for (auto it_segment : verSegments) {
									...
									std::shared_ptr<IFC4X3::IfcAlignment2DVerSegCircularArc> v_seg_circ_arc_2D =
										std::dynamic_pointer_cast<IFC4X3::IfcAlignment2DVerSegCircularArc>(it_segment);
									std::shared_ptr<IFC4X3::IfcAlignment2DVerSegLine> ver_seg_line_2D =
										std::dynamic_pointer_cast<IFC4X3::IfcAlignment2DVerSegLine>(it_segment);
									std::shared_ptr<IFC4X3::IfcAlignment2DVerSegParabolicArc> v_seg_par_arc_2D =
										std::dynamic_pointer_cast<IFC4X3::IfcAlignment2DVerSegParabolicArc>(it_segment);
								...
								for (auto it_ver_segments : VerSegmentsVec)
								{
									...
									if (segType == isCircArc) {
										...
										for (auto it_ver_stations : it_ver_segments.segmentStations_) {
											...
											// Get circular arc segment information.
											std::shared_ptr<OpenInfraPlatform::IFC4X3::IfcAlignment2DVerSegCircularArc> v_seg_circ_arc_2D =
												std::dynamic_pointer_cast<OpenInfraPlatform::IFC4X3::IfcAlignment2DVerSegCircularArc>(it_ver_segments.itVertical_);
											// Radius type IfcPositiveLengthMeasure [1:1] 
									...
									if (segType == isParArc) {
										...
										for (auto it_ver_stations : it_ver_segments.segmentStations_) {
											...
											std::shared_ptr<OpenInfraPlatform::IFC4X3::IfcAlignment2DVerSegParabolicArc> v_seg_par_arc_2D =
												std::dynamic_pointer_cast<OpenInfraPlatform::IFC4X3::IfcAlignment2DVerSegParabolicArc>(it_ver_segments.itVertical_);
