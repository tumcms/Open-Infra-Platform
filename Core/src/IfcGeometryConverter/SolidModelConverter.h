			...
			*/
				...
				std::stringstream& err)
			{
				...
				if (manifoldSolidBrep) {
					...
					std::shared_ptr<OpenInfraPlatform::IFC4X3::IfcAdvancedBrep> advanced_brep =
						std::dynamic_pointer_cast<OpenInfraPlatform::IFC4X3::IfcAdvancedBrep>(manifoldSolidBrep);
					if (advanced_brep)
					{
						...
						std::shared_ptr<OpenInfraPlatform::IFC4X3::IfcAdvancedBrepWithVoids> advanced_brep_with_voids =
							std::dynamic_pointer_cast<OpenInfraPlatform::IFC4X3::IfcAdvancedBrepWithVoids>(advanced_brep);
				...
				std::shared_ptr<OpenInfraPlatform::IFC4X3::IfcSectionedSolid> sectioned_solid =
					std::dynamic_pointer_cast<OpenInfraPlatform::IFC4X3::IfcSectionedSolid>(solidModel);
				...
				if (sectioned_solid)
				{
					...
					std::shared_ptr<OpenInfraPlatform::IFC4X3::IfcSectionedSolidHorizontal> sectioned_solid_horizontal =
						std::dynamic_pointer_cast<OpenInfraPlatform::IFC4X3::IfcSectionedSolidHorizontal>(sectioned_solid);

					if (sectioned_solid_horizontal)
					{
						// Get cross section positions and fixed axis vertical (attributes 3-4).
						std::vector<std::shared_ptr<OpenInfraPlatform::IFC4X3::IfcDistanceExpression>> vec_cross_section_positions;
				...
				if (swept_area_solid)
				{
					...
					std::shared_ptr<OpenInfraPlatform::IFC4X3::IfcFixedReferenceSweptAreaSolid> fixed_ref_swept_area_solid =
						std::dynamic_pointer_cast<OpenInfraPlatform::IFC4X3::IfcFixedReferenceSweptAreaSolid>(swept_area_solid);
...
// TO DO: implement / check current implementation //
				...
				if (swept_disk_solid)
				{
					...
					std::shared_ptr<OpenInfraPlatform::IFC4X3::IfcSweptDiskSolidPolygonal> swept_disk_solid_polygonal =
						std::dynamic_pointer_cast<OpenInfraPlatform::IFC4X3::IfcSweptDiskSolidPolygonal>(swept_disk_solid);
				...
				std::stringstream& err)
			{
				...
				*/
				...
				if (half_space_solid)
				{
					...
					BLUE_LOG(trace) << "base_surface: IfcSurface  #" << base_surface->getId();
