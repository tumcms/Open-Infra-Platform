			...
			*/
			...
			public:
				...
				*/
				...
				{
					if (areEqual(first.x,second.x, precision) && areEqual(first.y, second.y, precision))
					{
						return true;
					}
					return false;
				...
				{
					if (areEqual(first.x, second.x, precision) && areEqual(first.y, second.y, precision) && areEqual(first.y, second.z, precision))
					{
						return true;
					}
					return false;
