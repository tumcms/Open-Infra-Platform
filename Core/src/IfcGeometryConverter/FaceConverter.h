					...
					std::shared_ptr<carve::input::PolylineSetData>& polyline_data)
				{
					...
					/*	Faceconverter.h
						...
						IfcSurface
							...
							IfcBoundedSurface						http://www.buildingsmart-tech.org/ifc/IFC4X2/final/html/schema/ifcgeometryresource/lexical/ifcboundedsurface.htm
								IfcBSplineSurface*
								IfcCurveBoundedPlane
								IfcCurveBoundedSurface*
								IfcRectangularTrimmedSurface*

							IfcElementarySurface					http://www.buildingsmart-tech.org/ifc/IFC4X2/final/html/schema/ifcgeometryresource/lexical/ifcelementarysurface.htm
								IfcCylindricalSurface*
								IfcPlane
								IfcSphericalSurface*
								IfcToroidalSurface*

							IfcSweptSurface							http://www.buildingsmart-tech.org/ifc/IFC4X2/final/html/schema/ifcgeometryresource/lexical/ifcsweptsurface.htm
					...
					*/
					...
					if(bounded_surface) {
						...
						std::shared_ptr<OpenInfraPlatform::IFC4X2::IfcBSplineSurface> bspline_surface =
							std::dynamic_pointer_cast<OpenInfraPlatform::IFC4X2::IfcBSplineSurface>(bounded_surface);
						...
						if(bspline_surface) {
							...
							for(auto& it_control_point_list : vec_control_point_list_list) {
								std::vector<std::shared_ptr<OpenInfraPlatform::IFC4X2::IfcCartesianPoint>> vec_control_point_list;
								...
								std::transform(it_control_point_list.begin(),
									...
									[](EXPRESSReference<OpenInfraPlatform::IFC4X2::IfcCartesianPoint> it) { return it.lock(); });
							...
							OpenInfraPlatform::IFC4X2::IfcBSplineSurfaceForm surface_form = bspline_surface->SurfaceForm;
							...
							std::shared_ptr<OpenInfraPlatform::IFC4X2::IfcBSplineSurface> bspline_knots = // bspline_surface zu bspline_knots
								std::dynamic_pointer_cast<OpenInfraPlatform::IFC4X2::IfcBSplineSurface>(bounded_surface);
						...
						std::shared_ptr<OpenInfraPlatform::IFC4X2::IfcCurveBoundedSurface> curve_bounded_surface =
							std::dynamic_pointer_cast<OpenInfraPlatform::IFC4X2::IfcCurveBoundedSurface>(bounded_surface);
						...
						if(curve_bounded_surface) {
							...
							std::shared_ptr<OpenInfraPlatform::IFC4X2::IfcSurface> basis_surface = curve_bounded_surface->BasisSurface.lock();
							/*std::shared_ptr<typename IfcEntityTypesT::IfcBoundaryCurve> boundaries =
								...
								// std::shared_ptr<OpenInfraPlatform::IFC4X2::IfcBoundaryCurve> boundaries = curve_bounded_surface->Boundaries;

							std::vector<std::shared_ptr<OpenInfraPlatform::IFC4X2::IfcBoundaryCurve>> vec_boundaries;
					...
					if(elementary_surface) {
						...
						std::shared_ptr<OpenInfraPlatform::IFC4X2::IfcCylindricalSurface> cylindrical_surface =
							std::dynamic_pointer_cast<OpenInfraPlatform::IFC4X2::IfcCylindricalSurface>(elementary_surface);
						...
						std::shared_ptr<OpenInfraPlatform::IFC4X2::IfcSphericalSurface> spherical_surface =
							std::dynamic_pointer_cast<OpenInfraPlatform::IFC4X2::IfcSphericalSurface>(elementary_surface);
						...
						std::shared_ptr<OpenInfraPlatform::IFC4X2::IfcToroidalSurface> toroidal_surface =
							std::dynamic_pointer_cast<OpenInfraPlatform::IFC4X2::IfcToroidalSurface>(elementary_surface);
