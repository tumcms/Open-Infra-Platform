%{
	...
	#include "ExpressBinding/src/OpenInfraPlatform/ExpressBinding/Meta/Entity.h"
	#include "ExpressBinding/src/OpenInfraPlatform/ExpressBinding/Meta/Type.h"
	#include "ExpressBinding/src/OpenInfraPlatform/ExpressBinding/Meta/EntityAttribute.h"
	#include "ExpressBinding/src/OpenInfraPlatform/ExpressBinding/Meta/Schema.h"
	#include "ExpressBinding/src/OpenInfraPlatform/ExpressBinding/memory.h"
	#include "ExpressBinding/src/OpenInfraPlatform/ExpressBinding/stack.h"
...
%union {
//	OpenInfraPlatform::ExpressBinding::RuleLabelIdentifier* rule_label_id;
...
explicit_attr:
	 attribute_decl explicit_attr1 TOKEN_COLON TOKEN_OPTIONAL parameter_type TOKEN_SEMICOLON
	 {
		...
		{
			assert(attribute_types.top()->getType() == oip::eEntityAttributeParamterType::eGeneralizedType);

			if(attribute_types.top()->getType() == oip::eEntityAttributeParamterType::eGeneralizedType)	{
		...
		if(attribute_types.size() >= 1) {
			assert(iterator->getType() == oip::eEntityAttributeParamterType::eGeneralizedType);
			auto p = std::static_pointer_cast<EntityAttributeGeneralizedType>(iterator);
			p->elementType = attribute_types.top();		
			attribute_types.pop();
		}
