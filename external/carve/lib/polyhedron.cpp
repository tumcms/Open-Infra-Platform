...
namespace carve {
  namespace poly {
    ...
    bool Polyhedron::initConnectivity() {
      ...
      std::unordered_map<std::pair<size_t, size_t>, std::list<mesh::Edge<3> *>, carve::_vs2013::pair_hash<size_t, size_t> > edge_map;
      ...
      size_t n_edges = 0;
      for (std::unordered_map<std::pair<size_t, size_t>, std::list<mesh::Edge<3> *>, carve::_vs2013::pair_hash<size_t, size_t> >::iterator i = edge_map.begin(); i != edge_map.end(); ++i) {
    ...
    void Polyhedron::testVertexAgainstClosedManifolds(const carve::geom3d::Vector &v,
      ...
      boost::random::uniform_on_sphere<double> distrib(3);
	  boost::random::variate_generator<boost::random::mt19937 &, boost::random::uniform_on_sphere<double> > gen(rng, distrib);
