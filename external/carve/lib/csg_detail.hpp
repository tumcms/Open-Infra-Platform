...
namespace carve {
  namespace csg {
    namespace detail {
	  ...
	  class LoopEdges : public std::unordered_map<V2, std::list<FaceLoop *>, carve::mesh::hash_vertex_pair > {
		  typedef std::unordered_map<V2, std::list<FaceLoop *>, carve::mesh::hash_vertex_pair > super;
