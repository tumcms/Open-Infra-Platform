...
#include "../UserInterface/Dialogues/MainWindow.h"
...
#include "../UserInterface/Dialogues/HelpBrowser.h"
...
//#include "../UserInterface/ViewPanel/Effects/AlignmentEffect.h"
#include "../UserInterface/Dialogues/resource.h"
#include "../UserInterface/Dialogues/VectorTableModel.h"
...
void OpenInfraPlatform::UserInterface::MainWindow::showEvent(QShowEvent* event) {
	...
	if (!loaded_) {
		...
		if (!testBlossCurve) {
			OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().import("testdata/LandXML/Mainbruecke_Klingenberg.xml");
		} else {
			double L = 20;
			double R = 5;
			...
			/*	buw::ReferenceCounted<buw::Alignment2DBased3D> alignment = buw::makeReferenceCounted<buw::Alignment2DBased3D>();
				...
				OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().addAlignment(alignment);*/
			}
			{
				/*buw::ReferenceCounted<buw::Alignment2DBased3D> alignment = buw::makeReferenceCounted<buw::Alignment2DBased3D>();
				buw::ReferenceCounted<buw::HorizontalAlignment2D> halignment = buw::makeReferenceCounted<buw::HorizontalAlignment2D>();
...
void OpenInfraPlatform::UserInterface::MainWindow::retranslatePropertyBrowser() {
	...
	//on_comboBoxAlignment_currentIndexChanged(OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().getSelectedAlignment());
}
...
void OpenInfraPlatform::UserInterface::MainWindow::createClothoid() {
	...
	OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().addAlignment(a);*/
}
...
void OpenInfraPlatform::UserInterface::MainWindow::on_actionImport_OSM_File_triggered() {
	...
	//		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().importOSM(
...
void OpenInfraPlatform::UserInterface::MainWindow::on_actionExportIIfcRoad_triggered() {
	...
	//		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().exportIfcRoadTUMProposal(filename.toStdString());
	//	}
	...
	//		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().exportIfcRoadTUMProposal(tempFilename.toStdString());

	//		//OpenInfraPlatform::Core::DataManagement::IfcZipper* ExportZipper = new OpenInfraPlatform::Core::DataManagement::IfcZipper(nullptr, QString(filename.data()), tempFilename, DEFL);

	//		QObject::connect(&OpenInfraPlatform::AsyncJob::getInstance(), SIGNAL(finished()), ExportZipper, SLOT(start()));
	//		QObject::connect(ExportZipper, &OpenInfraPlatform::Core::DataManagement::IfcZipper::finished, ExportZipper, &QObject::deleteLater);
	//	}
	//}
}
...
void OpenInfraPlatform::UserInterface::MainWindow::on_actionTerrain_Create_Terrain_from_Heightmap_triggered() {
	...
	if (openFile.isNull() == false) {
		...
		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().createTerrainFromHeightMap(filename);
	}*/
}
...
void OpenInfraPlatform::UserInterface::MainWindow::on_actionExportLandInfra_triggered() {
	...
	//if (!filename.isNull()) {
	//	OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().exportLandInfra(filename.toStdString());
	//}
}
...
void OpenInfraPlatform::UserInterface::MainWindow::updateAlignmentUI() {
	//buw::ReferenceCounted<buw::AlignmentModel> am = OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().getAlignmentModel();
...
void OpenInfraPlatform::UserInterface::MainWindow::updateAlignmentElementsUI() {
	//int index = OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().getSelectedAlignment();
...
void OpenInfraPlatform::UserInterface::MainWindow::onChange(ChangeFlag changeFlag) {
	...
	/*if (changeFlag & ChangeFlag::DigitalElevationModel) {
		buw::ReferenceCounted<buw::DigitalElevationModel> dem = OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().getDigitalElevationModel();
	...
	//	buw::ReferenceCounted<OpenInfraPlatform::Infrastructure::ProxyModel> pm = OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().getProxyModel();
...
void OpenInfraPlatform::UserInterface::MainWindow::on_comboBoxAlignment_currentIndexChanged(int index) {
	/*if (index != OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().getSelectedAlignment() && index != -1) {
...
void OpenInfraPlatform::UserInterface::MainWindow::on_actionLandXML_triggered() {
	...
	//if (!filename.isNull()) {
	//	OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().exportLandXML(filename.toStdString());
	//}
}
...
void OpenInfraPlatform::UserInterface::MainWindow::on_actionAdvancedSVG_triggered() {
	...
	//if (!filename.isNull()) {
	//	OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().exportSVGAdvanced(filename.toStdString());
	//}
}
...
void OpenInfraPlatform::UserInterface::MainWindow::on_actionUsualSVG_triggered() {
	...
	/*if (!filename.isNull()) {
		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().exportSVG(filename.toStdString());
	}*/
}
...
void OpenInfraPlatform::UserInterface::MainWindow::prepareTest(int i) {
	...
	case 0:
		...
		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().import("testdata/LandXML/B15n_Data/B15n.xml");
		break;
	...
	case 2:
		...
		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().import("testdata/LandXML/AutoCAD Civil 3D/LandXMLDemo.xml");
		break;
	...
	case 3:
		...
		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().import("testdata/LandXML/ProVI/002LR.xml");
		break;
	...
	case 4:
		...
		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().import("testdata/LandXML/AutoCAD Civil 3D/debug.xml");
		break;
	...
	case 5:
		...
		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().import("testdata/LandXML/HbfMhfZweiteStammstrecke/HbfMhfZweiteStammstrecke.xml");
		break;
	...
	case 6:
		...
		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().import("testdata/LandXML/HbfMhfZweiteStammstrecke/2teStammstreckeBeide.xml");
		break;
	...
	case 7:
		...
		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().import("testdata/LandXML/CityCad/Sito_Tie.xml");
		break;
	...
	case 8:
		...
		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().import("testdata/LandXML/RIB STRATIS/BAB_A6.xml");
		break;
	...
	case 9:
		...
		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().import("testdata/LandXML/RIB STRATIS/St2237-Sulzkirchen.xml");
		break;
	...
	case 10:
		...
		//// export Oktra
		// case 11:
		//	OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().exportOkstra("Mainbruecke_Klingenberg_OKSTRA_export_1_13.xml", "1.013");
		//	break;

		// case 12:
		//	OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().exportOkstra("Mainbruecke_Klingenberg_OKSTRA_export_1_14.xml", "1.014");
		//	break;

		// case 13:
		//	OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().exportOkstra("Mainbruecke_Klingenberg_OKSTRA_export_1_13.cte", "1.013");
		//	break;

		// case 14:
		//	OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().exportOkstra("Mainbruecke_Klingenberg_OKSTRA_export_1_14.cte", "1.014");
		//	break;

		//// import Okstra
		// case 15:
		//	OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().import("Mainbruecke_Klingenberg_OKSTRA_export_1_13.xml");
		//	break;

		// case 16:
		//	OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().import("Mainbruecke_Klingenberg_OKSTRA_export_1_14.xml");
		//	break;

		// case 17:
		//	OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().import("Mainbruecke_Klingenberg_OKSTRA_export_1_13.cte");
		//	break;

		// case 18:
		//	OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().import("Mainbruecke_Klingenberg_OKSTRA_export_1_14.cte");
		//	break;
...
//		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().exportOkstra(filename.toStdString(), version.toStdString());
//	}
//}
//
...
//
//	if (!filename.isNull()) {
//		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().exportOkstraTranslated(filename.toStdString());
//	}
//}
//
...
//
//	if (!filename.isNull()) {
//		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().exportIfcOWL4x1(filename.toStdString());
//	}
//}
//
...
//
//	if (!filename.isNull()) {
//		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().exportOkstraOWL(filename.toStdString());
//	}
//}
...
void OpenInfraPlatform::UserInterface::MainWindow::on_pushButtonDeleteSelectedAlignment_clicked() {
	...
	if (am->getAlignmentCount() > index && index >= 0) {
		...
		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().execute(actionDeleteAlignment);
	}*/
}
...
void OpenInfraPlatform::UserInterface::MainWindow::on_pushButtonDeleteSurface_clicked() {
	...
	//	OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().execute(actionDeleteSurface);
	//}
}
...
void OpenInfraPlatform::UserInterface::MainWindow::on_actionExport_Terrain_As_Heightmap_triggered() {
	...
	if (openFile.isNull() == false) {
		buw::ReferenceCounted<OpenInfraPlatform::Infrastructure::DigitalElevationModel> dem =
		  OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().getDigitalElevationModel();
...
void OpenInfraPlatform::UserInterface::MainWindow::on_actionImport_IFC_Alignment_1_0_triggered() {
	...
	/*if (!filename.isNull()) {
		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().importIfcAlignment1_0(filename.toStdString());
	}*/
}
...
void OpenInfraPlatform::UserInterface::MainWindow::on_actionAlignments_as_3D_Points_txt_triggered() {
	...
	/*if (filename.isNull() == false) {
		OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().export3DAlignmentAsTextfile(filename.toStdString());
	}*/
}
...
void OpenInfraPlatform::UserInterface::MainWindow::on_actionMerge_Mesh_triggered() {
	...
	//	OpenInfraPlatform::Core::DataManagement::DocumentManager::getInstance().getData().createTerrainFromMesh(filename);
	//}
}
//
