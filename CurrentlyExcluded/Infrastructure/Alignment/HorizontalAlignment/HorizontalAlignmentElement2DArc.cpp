...
bool OpenInfraPlatform::Infrastructure::HorizontalAlignmentElement2DArc::genericQuery(const int id, void* result) const {
    ...
    case OpenInfraPlatform::Infrastructure::eAlignmentElementQueryId::RadiusStart: *reinterpret_cast<double*>(result) = getRadius(); break;
    case OpenInfraPlatform::Infrastructure::eAlignmentElementQueryId::RadiusEnd: *reinterpret_cast<double*>(result) = getRadius(); break;
