...
namespace emt
{
	template <
		...
		typename IfcArcIndexT,
		typename IfcAreaDensityMeasureT,
		...
		typename IfcBearingT,
		typename IfcBearingTypeT,
		typename IfcBearingTypeDisplacementEnumT,
		typename IfcBearingTypeEnumT,
		...
		typename IfcBridgePartTypeEnumT,
		typename IfcBridgeTypeEnumT,
		...
		typename IfcCaissonFoundationT,
		typename IfcCaissonFoundationTypeT,
		typename IfcCaissonFoundationTypeEnumT,
		...
		typename IfcCourseT,
		typename IfcCourseTypeT,
		typename IfcCourseTypeEnumT,
		...
		typename IfcDeepFoundationT,
		typename IfcDeepFoundationTypeT,
		...
		typename IfcDistributionPortTypeEnumT,
		...
		typename IfcFacilityT,
		typename IfcFacilityPartT,
		...
		typename IfcProductRepresentationSelectT,
		...
		typename IfcPropertySetDefinitionSelectT,
		typename IfcPropertySetDefinitionSetT,
		...
		typename IfcRoadT,
		typename IfcRoadPartT,
		typename IfcRoadPartTypeEnumT,
		typename IfcRoadTypeEnumT,
		...
		typename IfcSegmentIndexSelectT,
		typename IfcSensorT,
		...
		typename IfcSoundPowerLevelMeasureT,
		typename IfcSoundPowerMeasureT,
		typename IfcSoundPressureLevelMeasureT,
		...
		typename IfcTendonConduitT,
		typename IfcTendonConduitTypeT,
		typename IfcTendonConduitTypeEnumT,
		...
		typename IfcVibrationDamperT,
		typename IfcVibrationDamperTypeT,
		typename IfcVibrationDamperTypeEnumT,
	...
	>
	struct BasicIFC4X2_BIM4ROADEntityTypes
	{
		...
		typedef IfcArcIndexT IfcArcIndex;
		typedef IfcAreaDensityMeasureT IfcAreaDensityMeasure;
		...
		typedef IfcBearingT IfcBearing;
		typedef IfcBearingTypeT IfcBearingType;
		typedef IfcBearingTypeDisplacementEnumT IfcBearingTypeDisplacementEnum;
		typedef IfcBearingTypeEnumT IfcBearingTypeEnum;
		typedef IfcBenchmarkEnumT IfcBenchmarkEnum;
		typedef IfcBendingParameterSelectT IfcBendingParameterSelect;
		typedef IfcBinaryT IfcBinary;
		...
		typedef IfcBridgePartTypeEnumT IfcBridgePartTypeEnum;
		typedef IfcBridgeTypeEnumT IfcBridgeTypeEnum;
		...
		typedef IfcCaissonFoundationT IfcCaissonFoundation;
		typedef IfcCaissonFoundationTypeT IfcCaissonFoundationType;
		typedef IfcCaissonFoundationTypeEnumT IfcCaissonFoundationTypeEnum;
		...
		typedef IfcCourseT IfcCourse;
		typedef IfcCourseTypeT IfcCourseType;
		typedef IfcCourseTypeEnumT IfcCourseTypeEnum;
		...
		typedef IfcDeepFoundationT IfcDeepFoundation;
		typedef IfcDeepFoundationTypeT IfcDeepFoundationType;
		...
		typedef IfcDistributionPortTypeEnumT IfcDistributionPortTypeEnum;
		...
		typedef IfcFacilityT IfcFacility;
		typedef IfcFacilityPartT IfcFacilityPart;
		...
		typedef IfcProductRepresentationSelectT IfcProductRepresentationSelect;
		...
		typedef IfcPropertySetDefinitionSelectT IfcPropertySetDefinitionSelect;
		typedef IfcPropertySetDefinitionSetT IfcPropertySetDefinitionSet;
		...
		typedef IfcRelPositionsT IfcRelPositions;
		...
		typedef IfcRoadT IfcRoad;
		typedef IfcRoadPartT IfcRoadPart;
		typedef IfcRoadPartTypeEnumT IfcRoadPartTypeEnum;
		typedef IfcRoadTypeEnumT IfcRoadTypeEnum;
		...
		typedef IfcSegmentIndexSelectT IfcSegmentIndexSelect;
		...
		typedef IfcSoundPowerLevelMeasureT IfcSoundPowerLevelMeasure;
		typedef IfcSoundPowerMeasureT IfcSoundPowerMeasure;
		typedef IfcSoundPressureLevelMeasureT IfcSoundPressureLevelMeasure;
		...
		typedef IfcTendonConduitT IfcTendonConduit;
		typedef IfcTendonConduitTypeT IfcTendonConduitType;
		typedef IfcTendonConduitTypeEnumT IfcTendonConduitTypeEnum;
		...
		typedef IfcVibrationDamperT IfcVibrationDamper;
		typedef IfcVibrationDamperTypeT IfcVibrationDamperType;
		typedef IfcVibrationDamperTypeEnumT IfcVibrationDamperTypeEnum;
